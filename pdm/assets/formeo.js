...
!(function (e) {
    ...
    function (module, exports, __webpack_require__) {
        ...
        function _objectWithoutProperties(e, t) {
            var o = {};
            for (var r in e) 0 <= t.indexOf(r) || (Object.prototype.hasOwnProperty.call(e, r) && (o[r] = e[r]));
            return o;
        }
        ...
        var _typeof =
            ...
            _createClass = (function () {
                function e(e, t) {
                    for (var o, r = 0; r < t.length; r++) (o = t[r]), (o.enumerable = o.enumerable || !1), (o.configurable = !0), "value" in o && (o.writable = !0), Object.defineProperty(e, o.key, o);
                }
                return function (t, o, r) {
                    return o && e(t.prototype, o), r && e(t, r), t;
                };
            })(),
            _helpers = __webpack_require__(1),
            _helpers2 = _interopRequireDefault(_helpers),
            _events = __webpack_require__(5),
                ...
                function DOM() {
                    _classCallCheck(this, DOM),
                        ...
                        (this.styleSheet = (function () {
                            ...
                            return e.setAttribute("media", "screen"), e.setAttribute("type", "text/css"), e.appendChild(document.createTextNode("")), document.head.appendChild(e), e.sheet;
                        })());
                }
                return (
                    (DOM.prototype.processTagName = function (e) {
                        var t;
                        if (("string" == typeof e && ((t = e), (e = { tag: t })), e.attrs)) {
                            var o = e.attrs.tag;
                            if (o) {
                                var r = o.filter(function (e) {
                                    return !0 === e.selected;
                                });
                                r.length && (t = r[0].value);
                            }
                        }
                        return (e.tag = t || e.tag), e;
                    }),
                    (DOM.prototype.create = function (elem) {
                        ...
                        var contentType,
                            ...
                            tag = _elem.tag,
                            processed = [],
                            wrap = { tag: "div", attrs: {}, className: [_helpers2.default.get(elem, "config.inputWrap") || "f-field-group"], content: [], config: {} },
                            requiredMark = { tag: "span", className: "text-error", content: "*" },
                            ...
                            appendContent = {
                                ...
                                array: function (e) {
                                    for (var t = 0; t < e.length; t++) (contentType = _this.contentType(e[t])), appendContent[contentType](e[t]);
                                },
                                function: function (e) {
                                    (e = e()), (contentType = _this.contentType(e)), appendContent[contentType](e);
                                },
                                undefined: function () {
                                    return null;
                                },
                        ...
                        if ((processed.push("tag"), elem.className)) {
                            ...
                            (elem.attrs = Object.assign({}, elem.attrs, { className: className })), delete elem.className;
                        }
                        if (elem.options) {
                            var _elem3 = elem,
                                options = _elem3.options;
                            if (((options = this.processOptions(options, elem, isPreview)), !this.holdsContent(element) || "button" === tag))
                                return (
                                    _helpers2.default.forEach(options, function (e) {
                            ...
                            appendContent.array.call(this, options), delete elem.content, processed.push("options");
                        }
                        if ((elem.attrs && (_this.processAttrs(elem, element, isPreview), processed.push("attrs")), elem.config)) {
                            ...
                            if (elem.config.label && "button" !== tag) {
                                ...
                                (label = isPreview ? _this.label(elem, "config.label") : _this.label(elem)),
                                    elem.config.hideLabel
                                        ? editablePreview && (element.contentEditable = !0)
                                        : _this.labelAfter(elem)
                                        ? ((wrap.className = "f-" + elem.attrs.type), label.insertBefore(element, label.firstChild), wrap.content.push(label), required && wrap.content.push(requiredMark))
                                        : (wrap.content.push(label), required && wrap.content.push(requiredMark), wrap.content.push(element));
                            } else editablePreview && (element.contentEditable = !0);
                            processed.push("config");
                        }
                        if ((elem.content && ((contentType = _this.contentType(elem.content)), appendContent[contentType].call(this, elem.content), processed.push("content")), elem.dataset)) {
                        ...
                        if (_helpers2.default.inArray(elem.fType, fieldDataBindings)) {
                            ...
                            (element[dataType] = elem), "fieldData" == dataType && (element.panelNav = elem.panelNav), processed.push(dataType);
                        }
                    ...
                    (DOM.prototype.processAttrs = function (e, t, o) {
                        var r = e.attrs,
                            n = void 0 === r ? {} : r;
                        delete n.tag,
                            o || n.name || !this.isInput(e.tag) || t.setAttribute("name", (0, _utils.uuid)(e)),
                            Object.keys(n).forEach(function (e) {
                                var o = _helpers2.default.safeAttrName(e),
                                    r = n[e] || "";
                                if (Array.isArray(r))
                                    if ("object" === _typeof(r[0])) {
                                        var i = r.filter(function (e) {
                                            return !0 === e.selected;
                                        });
                                        r = i.length ? i[0].value : r[0].value;
                                    } else r = r.join(" ");
                                r && t.setAttribute(o, r);
                            });
                    }),
                    (DOM.prototype.checkbox = function (e) {
                        return { tag: "label", attrs: {}, content: [e, { tag: "span", className: "checkable", content: _helpers2.default.get(e, "elem.config.label") || "" }] };
                    }),
                    (DOM.prototype.processOptions = function (e, t, o) {
                        ...
                        return e.map(function (e, n) {
                            var l = function () {
                                var l = { tag: "input", attrs: { id: a, type: i, value: e.value || "" }, action: r },
                                    s = { tag: "span", className: "checkable", content: e.label },
                                    d = { tag: "label", attrs: {}, config: { inputWrap: "form-check" }, content: [e.label] },
                                    f = { tag: "div", content: [d], className: ["f-" + i] };
                                if ((t.attrs.className && (t.config.inputWrap = t.attrs.className), t.config.inline && f.className.push("f-${fieldType}-inline"), e.selected && (l.attrs.checked = !0), o)) {
                                    (l.fMap = "options[" + n + "].selected"), (d.attrs.contenteditable = !0), (d.fMap = "options[" + n + "].label"), (s.content = void 0);
                                    var c = { tag: "label", content: [l, s] };
                                    f.content.unshift(c);
                                } else (l.attrs.name = a), (d.content = s), (d = dom.create(d)), (l = dom.create(l)), d.insertBefore(l, d.firstChild), (f.content = d);
                                return f;
                            };
                            return {
                                select: function () {
                                    return { tag: "option", attrs: e, content: e.label };
                                },
                                button: function (e) {
                                    var o = e.type,
                                        r = e.label,
                                        n = e.className,
                                        i = e.id;
                                    return Object.assign({}, t, { attrs: { type: o }, className: n, id: i || (0, _utils.uuid)(), options: void 0, content: r, action: t.action });
                                },
                                checkbox: l,
                                radio: l,
                            }[i](e);
                    ...
                    (DOM.prototype.isInput = function (e) {
                        return "string" != typeof e && (e = e.tagName), -1 !== ["input", "textarea", "select"].indexOf(e);
                    }),
                    ...
                    (DOM.prototype.label = function (e, t) {
                        var o = { tag: "label", attrs: {}, className: [], content: e.config.label, action: {} };
                        if (this.labelAfter(e)) {
                            var r = { tag: "span", className: "checkable", content: e.config.label };
                            o.content = r;
                        }
                        return e.id && (o.attrs.for = e.id), t && (delete o.attrs.for, (o.attrs.contenteditable = !0), (o.fMap = t)), dom.create(o);
                    }),
                    (DOM.prototype.contentType = function (e) {
                        var t = void 0 === e ? "undefined" : _typeof(e);
                        return e instanceof Node || e instanceof HTMLElement ? (t = "node") : Array.isArray(e) && (t = "array"), t;
                    }),
                    (DOM.prototype.getStyle = function (e) {
                        var t,
                            o = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                        return window.getComputedStyle ? (t = window.getComputedStyle(e, null)) : e.currentStyle && (t = e.currentStyle), o ? t[o] : t;
                    }),
                    ...
                    (DOM.prototype.empty = function (e) {
                    ...
                    (DOM.prototype.actionButtons = function (e) {
                        var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "column",
                            o = this,
                            r = "column" === t ? "li" : "div",
                            n = { tag: "div", className: "action-btn-wrap" },
                            i = {
                                tag: r,
                                className: t + "-actions group-actions",
                                action: {
                                    mouseenter: function (o) {
                                        var r = document.getElementById(e);
                                        r.classList.add("hovering-" + t), (o.target.parentReference = r);
                                    },
                                    ...
                                    onRender: function (e) {
                                        ...
                                        o.insertRule([[".hovering-" + t + " ." + t + "-actions", [a, i, !0]]]);
                                    },
                                },
                            };
                        ...
                        return (
                            ...
                            t || ((t = e.parentElement), (l = !0)),
                            {
                                ...
                                fields: function () {
                                    ...
                                    return t.insertBefore(e, t.childNodes[a]), e;
                                },
                            }[n]()
                        );
                    }),
                    (DOM.prototype.removeEmpty = function (e) {
                        var t,
                            ...
                            r = e.parentElement,
                            n = e.fType;
                        if ((o.remove(e), (t = r.getElementsByClassName("stage-" + n)), !t.length)) {
                            if ("stages" !== r.fType) return o.removeEmpty(r);
                            this.emptyClass(r);
                        }
                        return "columns" === n && o.columnWidths(r), _data2.data.save();
                    }),
                    (DOM.prototype.remove = function (e) {
                        ...
                        if (t) {
                            ...
                            _data2.data.empty(t, o), this[t].delete(o), _data2.formData[t].delete(o), (0, _utils.remove)(n[t], o);
                        }
                    ...
                    (DOM.prototype.removeClasses = function (e, t) {
                        var o = this,
                            r = {
                                ...
                                array: function (e) {
                                    for (var o = t.length - 1; 0 <= o; o--) e.classList.remove(t[o]);
                                },
                            };
                        (r.object = r.string), _helpers2.default.forEach(e, r[o.contentType(t)]);
                    }),
                    (DOM.prototype.addClasses = function (e, t) {
                        var o = this;
                        _helpers2.default.forEach(
                            e,
                            {
                                string: function (e) {
                                    e.classList.add(t);
                    ...
                    (DOM.prototype.fieldOrderClass = function (e) {
                        ...
                        t.length && (this.removeClasses(t, ["first-field", "last-field"]), t[0].classList.add("first-field"), t[t.length - 1].classList.add("last-field"));
                    }),
                        ...
                        if (r.length) {
                            ...
                            t.removeClasses(r, /\bcol-\w+-\d+/g),
                                _helpers2.default.forEach(r, function (e) {
                                    ...
                                    (e.style.width = r), (e.style.float = "left"), (t.config.width = r), (e.dataset.colWidth = r), document.dispatchEvent(_events2.default.columnResized);
                                }),
                                setTimeout(function () {
                    ...
                    (DOM.prototype.formGroup = function (e) {
                        return { tag: "div", className: ["f-field-group", 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : ""], content: e };
                    }),
                        ...
                        var t = this,
                            ...
                            n = {
                                ...
                                action: {
                                    change: function (r) {
                                        var n = t.rows.get(e);
                                        o.setColumnWidths(n.row, r.target.value), _data2.data.save();
                                    },
                                },
                            },
                            i = new Map(),
                            a = { value: "custom", label: "Custom" };
                        if (
                            (i.set(1, [{ value: "100.0", label: "100%" }]),
                            i.set(2, [{ value: "50.0,50.0", label: "50 | 50" }, { value: "33.3,66.6", label: "33 | 66" }, { value: "66.6,33.3", label: "66 | 33" }, a]),
                            i.set(3, [
                            ...
                            var d = l
                                .map(function (e) {
                                    return _data2.formData.columns.get(e).config.width.replace("%", "");
                                })
                                .join(",");
                            s &&
                    ...
                    (DOM.prototype.setColumnWidths = function (e, t) {
                        if ("custom" !== t) {
                            ...
                            _helpers2.default.forEach(o, function (e, o) {
                                var r = t[o] + "%";
                                (e.dataset.colWidth = r), (e.style.width = r), (_data2.formData.columns.get(e.id).config.width = r);
                            });
                        }
                    }),
                    ...
                    (DOM.prototype.loadRows = function (e) {
                        var t = this;
                        return (
                            e || (e = this.activeStage),
                            _data2.formData.stages.get(e.id).rows.forEach(function (o) {
                                var r = t.addRow(e.id, o);
                                t.loadColumns(r), dom.updateColumnPreset(r), e.appendChild(r);
                            })
                        );
                    }),
                    ...
                    (DOM.prototype.createColumn = function (e) {
                        ...
                        return o.classList.add("first-field"), r.appendChild(o), _data2.formData.columns.get(r.id).fields.push(o.id), r;
                    }),
                    ...
                    (DOM.prototype.renderForm = function (e) {
                                    ...
                                    (r = r.map(function (e) {
                                        var r = o.rows[e],
                                            ...
                                            a = n.map(function (e) {
                                                ...
                                                return (r.tag = "div"), (r.content = n), r;
                                            });
                                        (i.tag = "div"), (i.content = [a]);
                                        ...
                                        if (i.config.inputGroup) {
                                            ...
                                            i.content.unshift(s), (d.content = [l, f]), (i = d);
                                        }
                                        return i;
                                    })),
                                    (n.tag = "div"),
                        ...
                        e.appendChild(this.create({ tag: "div", id: "formeo-rendered-" + r, className: "formeo-render formeo", content: n }));
                    }),
                    ...
                    (DOM.prototype.clearStage = function (e) {
                        e.classList.add("removing-all-fields"),
                            _animation2.default.slideUp(e, 600, function () {
                                dom.empty(e), e.classList.remove("removing-all-fields"), _data2.data.save(), dom.emptyClass(e), _animation2.default.slideDown(e, 300);
                            });
                    }),
                    (DOM.prototype.addRow = function (e, t) {
                        ...
                        return (
                            ...
                            this.emptyClass(r),
                            (_events2.default.formeoUpdated = new CustomEvent("formeoUpdated", { data: { updateType: "added", changed: "row", oldValue: void 0, newValue: _data2.formData.rows.get(o.id) } })),
                    ...
                    (DOM.prototype.addColumn = function (e, t) {
                        ...
                        return (
                            ...
                            this.emptyClass(r),
                            (_events2.default.formeoUpdated = new CustomEvent("formeoUpdated", { data: { updateType: "added", changed: "column", oldValue: void 0, newValue: _data2.formData.columns.get(o.id) } })),
                            document.dispatchEvent(_events2.default.formeoUpdated),
                            o
                        );
                    }),
                    (DOM.prototype.toggleSortable = function (e, t) {
                        ...
                        if (o) {
                            ...
                            void 0 === t && (t = !n.option("disabled")), n.option("disabled", t), r && _helpers2.default.inArray(r, ["rows", "columns", "stages"]) && this.toggleSortable(e.parentElement, t);
                        }
                    }),
                    (DOM.prototype.addField = function (e, t) {
                        ...
                        if (e) {
                            ...
                            r.appendChild(o), _data2.data.saveFieldOrder(r), this.emptyClass(r);
                        }
                        return (
                            (_events2.default.formeoUpdated = new CustomEvent("formeoUpdated", { data: { updateType: "add", changed: "field", oldValue: void 0, newValue: _data2.formData.fields.get(o.id) } })),
                            document.dispatchEvent(_events2.default.formeoUpdated),
                            o
                        );
                    }),
                    (DOM.prototype.emptyClass = function (e) {
                        ...
                        if (t) {
                            var o = new Map();
                            o.set("rows", "columns"), o.set("columns", "fields"), o.set("stages", "rows");
                    ...
                    (DOM.prototype.insertRule = function (e) {
                        for (var t = this.styleSheet, o = t.cssRules.length, r = 0, n = e.length; r < n; r++) {
                            var i = 1,
                                a = e[r],
                                l = e[r][0],
                                s = "";
                    ...
                    _createClass(DOM, [
                        {
                            ...
                            set: function (e) {
                                var t = this,
                                    o = t.icon,
                                    r = { tag: "button", content: [], attrs: { className: ["btn"], type: "button" } },
                                    n = _helpers2.default.merge(Object.assign({}, r), { content: [o("move"), o("handle")], attrs: { className: ["item-handle"] }, meta: { id: "handle" } }),
                                    i = _helpers2.default.merge(Object.assign({}, r), {
                                        content: o("edit"),
                                        attrs: { className: ["item-edit-toggle"] },
                                        meta: { id: "edit" },
                                        action: {
                                            click: function (e) {
                                                var t = (0, _utils.closestFtype)(e.target),
                                                    o = t.fType;
                                                o = o.replace(/s$/, "");
                                                var r = "editing-" + o,
                                                    n = t.querySelector("." + o + "-edit");
                                                _animation2.default.slideToggle(n, 333), "field" === o && (_animation2.default.slideToggle(n.nextSibling, 333), t.parentElement.classList.toggle("column-" + r)), t.classList.toggle(r);
                                            },
                                        },
                                    }),
                                    a = _helpers2.default.merge(Object.assign({}, r), {
                                        content: o("remove"),
                                        attrs: { className: ["item-remove"] },
                                        meta: { id: "remove" },
                                        action: {
                                            click: function (e) {
                                                var o = (0, _utils.closestFtype)(e.target);
                                                _animation2.default.slideUp(o, 250, function (e) {
                                                    t.removeEmpty(e);
                                                });
                                            },
                                        },
                                    }),
                                    l = _helpers2.default.merge(Object.assign({}, r), {
                                        content: o("copy"),
                                        attrs: { className: ["item-clone"] },
                                        meta: { id: "clone" },
                                        action: {
                                            click: function (e) {
                                                t.clone((0, _utils.closestFtype)(e.target)), _data2.data.save();
                                            },
                                        },
                                    }),
                                    s = {
                                        rows: { actionButtons: { buttons: [(0, _utils.clone)(n), i, l, a], order: [], disabled: [] } },
                                        columns: { actionButtons: { buttons: [(0, _utils.clone)(l), (0, _utils.clone)(n), a], order: [], disabled: [] } },
                                        fields: { actionButtons: { buttons: [n, i, l, a], order: [], disabled: [] } },
                                    };
                                (s.rows.actionButtons.buttons[0].content = [o("move-vertical"), o("handle")]), (s.columns.actionButtons.buttons[0].content = [o("copy"), o("handle")]);
                                var d = _helpers2.default.merge(s, e);
                                return (
                                    Object.keys(d).forEach(function (e) {
                                        if (d[e].actionButtons) {
                                            var t = d[e].actionButtons,
                                                o = t.disabled,
                                                r = t.buttons;
                                            (t.buttons = _helpers2.default.orderObjectsBy(r, t.order, "meta.id")),
                                                (t.buttons = t.buttons.filter(function (e) {
                                                    var t = _helpers2.default.get(e, "meta.id");
                                                    return !_helpers2.default.inArray(t, o);
                                                }));
                                        }
                                    }),
                                    d.dir && (this.dir = d.dir),
                                    (this.config = d),
                                    this.config
                                );
                            },
        ...
        var r =
            ...
            l = function (e) {
                ...
                return (
                    Array.isArray(e)
                        ? (t = e)
                        : e.replace(/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(\.|\[\])(?:\4|$))/g, function (e, o, r, n) {
                              var i;
                              (i = r ? n.replace(/\\(\\)?/g, "$1") : o || e), t.push(i);
                          }),
                    t
                );
            },
            s = {
                hyphenCase: function (e) {
                    return (
                ...
                safeAttrName: function (e) {
                    return { className: "class" }[e] || s.hyphenCase(e);
                },
                ajax: function (e, t) {
                    return new window.Promise(function (o, r) {
                        var n = new XMLHttpRequest();
                        n.open("GET", e, !0),
                            (n.onload = function () {
                                200 <= this.status && 300 > this.status ? (t(n), o(n.response)) : r({ status: this.status, statusText: n.statusText });
                            }),
                            (n.onerror = function () {
                                r({ status: this.status, statusText: n.statusText });
                            }),
                            n.send();
                    });
                },
                insertIcons: function (e) {
                    var t = "formeo-sprite",
                        o = i.default.create({ tag: "div", content: e.responseText, id: t });
                    o.style.display = "none";
                    var r = document.getElementById(t);
                    r ? r.parentElement.replaceChild(o, r) : document.body.insertBefore(o, document.body.childNodes[0]);
                },
                insertStyle: function (e) {
                    var t = i.default.create({ tag: "style", content: e.responseText });
                ...
                forEach: function (e, t, o) {
                    for (var r = 0; r < e.length; r++) t.call(o, e[r], r);
                },
                copyObj: function (e) {
                ...
                indexOfNode: function (e, t) {
                    var o = t || e.parentElement;
                    return Array.prototype.slice.call(o.childNodes).indexOf(e);
                },
                isInt: function (e) {
                    return +e === e && 0 == e % 1;
                },
                get: function (e, t) {
                    t = l(t);
                    for (var o = 0, r = t.length; null != e && o < r; ) e = e[t[o++]];
                    return o && o === r ? e : void 0;
                },
                set: function (e, t, o, n) {
                    t = l(t);
                    for (var i, a = -1, s = t.length, d = e; null !== d && ++a < s; ) {
                        if (((i = t[a]), "object" === (void 0 === d ? "undefined" : r(d)))) {
                            var f = o;
                            if (a != s - 1) {
                                var c = d[i];
                                void 0 === (f = n ? n(c, i, d) : void 0) && (f = null === c ? [] : c);
                            }
                            (hasOwnProperty.call(d, i) && d[i] === f && (void 0 !== f || i in d)) || (d[i] = f);
                        }
                        d = d[i];
                    }
                    return e;
                ...
                merge: function (e, t) {
                    ...
                    for (var n in t) o.hasOwnProperty(n) && (o[n] = Array.isArray(t[n]) ? (e && Array.isArray(e[n]) ? e[n].concat(t[n]) : t[n]) : "object" === r(t[n]) ? s.merge(e[n], t[n]) : t[n]);
                    return o;
                },
                orderObjectsBy: function (e, t, o) {
                    var r = (0, a.unique)(t),
                        n = r
                            .map(function (t) {
                ...
                toggleElementsByStr: function (e, t) {
                    var o = [];
                    return (
                        s.forEach(e, function (e) {
                            -1 === e.textContent.toLowerCase().indexOf(t.toLowerCase()) ? (e.style.display = "none") : ((e.style.display = "block"), o.push(e));
                        }),
                        o
                    );
                },
    ...
    function (e, t, o) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), (t.registeredFields = t.formData = t.data = void 0);
        var n,
            i = o(5),
            a = r(i),
            l = o(1),
            ...
            p = {
                init: function (e, o) {
                    var r = { id: (0, c.uuid)(), settings: new Map(), stages: new Map(), rows: new Map(), columns: new Map(), fields: new Map() };
                    u.opts = e;
                    var i = function (e) {
                        "string" == typeof e && (e = window.JSON.parse(e)),
                            (e.settings = (0, c.objToStrMap)(e.settings)),
                            (e.stages = (0, c.objToStrMap)(e.stages)),
                            (e.rows = (0, c.objToStrMap)(e.rows)),
                            (e.columns = (0, c.objToStrMap)(e.columns)),
                            (e.fields = (0, c.objToStrMap)(e.fields)),
                            (t.formData = n = Object.assign({}, r, e));
                    };
                    if (o) i(o);
                    else if (window.sessionStorage && u.opts.sessionStorage) {
                        var a = window.sessionStorage.getItem("formData");
                        a && i(a);
                    }
                    return n || (t.formData = n = r), n;
                },
                saveColumnOrder: function (e) {
                    var t = e.getElementsByClassName("stage-columns"),
                        o = s.default.map(t, function (e) {
                            return t[e].id;
                        });
                    return (n.rows.get(e.id).columns = o), o;
                },
                saveFieldOrder: function (e) {
                    var t = e.getElementsByClassName("stage-fields"),
                        o = s.default.map(t, function (e) {
                            return t[e].id;
                        });
                    return (n.columns.get(e.id).fields = o), o;
                },
                saveRowOrder: function (e) {
                    e || (e = f.default.activeStage);
                    var t = n.stages.get(e.id).rows.slice(),
                        o = e.getElementsByClassName("stage-rows"),
                        r = s.default.map(o, function (e) {
                            return o[e].id;
                        });
                    return (n.stages.get(e.id).rows = r), new CustomEvent("formeoUpdated", { data: { updateType: "sort", changed: "rows", oldValue: t, newValue: r } }), document.dispatchEvent(a.default.formeoUpdated), r;
                },
                saveOptionOrder: function (e) {
                    var t = e.getElementsByClassName("prop-wrap"),
                        o = s.default.map(t, function (e) {
                            return t[e].propData;
                        });
                    return (n.fields.get(e.fieldID)[e.editGroup] = o), o;
                },
                saveOrder: function (e, t) {
                    return { row: p.saveRowOrder, column: p.saveColumnOrder, field: p.saveFieldOrder, options: p.saveOptionOrder }[e](t);
                },
                saveType: function (e, t) {
                    return {
                        settings: function () {
                            return n.settings;
                        },
                        ...
                        field: function (e) {
                            return n.fields.get(e);
                        },
                        attrs: function (e) {
                            var t = n.fields.get(e.fieldID),
                                o = t.attrs;
                            return (a.default.formeoUpdated = new CustomEvent("formeoUpdated", { data: { changed: "field.attrs", updateType: "update", attrValues: o } })), document.dispatchEvent(a.default.formeoUpdated), o;
                        },
                        options: function (e) {
                            var t = n.fields.get(e.fieldID).options,
                                o = p.saveOrder("options", e);
                            return (a.default.formeoUpdated = new CustomEvent("formeoUpdated", { data: { changed: "field.options", updateType: "sort", oldValue: t, newValue: o } })), document.dispatchEvent(a.default.formeoUpdated), o;
                        },
                    }[e](t);
                },
                empty: function (e, t) {
                    var o = {},
                        r = {
                            stages: function (e) {
                                e || (e = f.default.activeStage.id);
                                var t = n.stages.get(e),
                                    i = t.rows;
                                (o.rows = i.map(function (e) {
                                    return r.rows(e), n.rows.delete(e), e;
                                })),
                                    (t.rows = []);
                            },
                            rows: function (e) {
                                ...
                                if (t) {
                                    var i = t.columns;
                                    (o.columns = i.map(function (e) {
                                        return r.columns(e), n.columns.delete(e), e;
                                    })),
                                        (i = []);
                                }
                            },
                            columns: function (e) {
                                var t = n.columns.get(e);
                                if (t) {
                                    var r = t.fields;
                                    (o.fields = r.map(function (e) {
                                        return n.fields.delete(e), e;
                                    })),
                                        (r = []);
                                }
                            },
                            fields: function (e) {
                                var t = f.default.fields.get(e);
                                if (t) {
                                    t = t.field;
                                    var o = n.columns.get(t.parentElement.id),
                                        r = o.fields.slice();
                                    (0, c.remove)(o.fields, e),
                                        (a.default.formeoUpdated = new CustomEvent("formeoUpdated", { data: { updateType: "removed", changed: "column.fields", oldValue: r, newValue: o.fields } })),
                                        document.dispatchEvent(a.default.formeoUpdated);
                                }
                            },
                        };
                    return r[e](t), o;
                ...
                saveThrottled: !1,
                save: function () {
                    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "stages",
                        t = arguments[1],
                    ...
                    var r = function () {
                        ...
                        return (
                            o && u.opts.sessionStorage && o.setItem("formData", p.json),
                            u.opts.debug && console.log("Saved: " + e),
                            (a.default.formeoSaved = new CustomEvent("formeoSaved", { detail: { formData: p.js } })),
                            document.dispatchEvent(a.default.formeoSaved),
                            n
                        );
                    };
                    return (
                        p.saveThrottle
                            ...
                            : (r(),
                              (p.saveThrottle = !0),
                              setTimeout(function () {
                                  p.saveThrottled && (r(), (p.saveThrottled = !1)), (p.saveThrottle = !1);
                              }, 500)),
                        n
                    );
                },
                get js() {
                    ...
                    return (
                        Object.keys(n).forEach(function (t) {
                            e[t] = "string" == typeof n[t] ? n[t] : (0, c.strMapToObj)(n[t]);
                        }),
                        e
                    );
                },
                    ...
                    return (
                        Object.keys(e).forEach(function (t) {
                            Object.keys(e[t]).forEach(function (o) {
                                var r = e[t][o];
                                r.action &&
                                    Object.keys(r.action).forEach(function (e) {
                                        r.action[e] = r.action[e].toString();
                                    });
                            });
                        }),
                        e
                ...
                get json() {
                    var e = p.prepData;
                    return window.JSON.stringify(e, null, "\t");
                },
            };
        (t.data = p), (t.formData = n), (t.registeredFields = {});
    },
    function (e, t, o) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.memoize = t.clicked = t.cleanObj = t.numberBetween = t.numToPercent = t.clone = t.uuid = t.strMapToObj = t.objToStrMap = t.unique = t.closestFtype = t.closest = t.remove = t.match = void 0);
        var r =
                "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
                    ? function (e) {
                          return typeof e;
            ...
            a =
                ((t.match = function () {
                    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "",
                        t = arguments[1];
                    if (!t) return console.warn("utils.match missing argument 2."), !1;
                    var o = "string" == typeof t ? [t] : t;
                    o = o.map(function (e) {
                        return "*" === e ? "" : e.replace(/[|\\{}()[\]^*$+?.]/g, "\\$&");
                    });
                    var r = !0;
                    return o.length && (r = !e.match(new RegExp(o.join("|"), "i"))), r;
                }),
                ...
                (t.closest = function (e, t) {
                    for (var o = t.replace(".", ""); (e = e.parentElement) && !e.classList.contains(o); );
                    return e;
                }),
                (t.closestFtype = function (e) {
                    for (; (e = e.parentElement) && !e.fType; );
                    return e;
                }),
                (t.unique = function (e) {
                ...
                (t.objToStrMap = function (e) {
                    for (var t = new Map(), o = Object.keys(e), r = Array.isArray(o), n = 0, o = r ? o : o[Symbol.iterator](); ; ) {
                        var i;
                        if (r) {
                            if (n >= o.length) break;
                            i = o[n++];
                ...
                (t.uuid = function (e) {
                    ...
                    if (e) {
                        var o = e.attrs;
                        (t = (void 0 === o ? {} : o).id || e.id || (0, i.default)()), (e.id = t);
                    } else t = (0, i.default)();
                    return t;
                }),
                (t.clone = function e(t) {
                    ...
                    if (t instanceof Date) return (o = new Date()), o.setTime(t.getTime()), o;
                    if (t instanceof Array) {
                        o = [];
                        for (var n = 0, i = t.length; n < i; n++) o[n] = e(t[n]);
                        return o;
                    }
                    if (t instanceof Object) {
                        for (var a in ((o = {}), t)) t.hasOwnProperty(a) && (o[a] = e(t[a]));
                        return o;
                    }
                    throw new Error("Unable to copy Object, type not supported.");
                }),
                (t.numToPercent = function (e) {
                    return e.toString() + "%";
                }),
                (t.numberBetween = function (e, t, o) {
                    return e > t && e < o;
                }));
        (t.cleanObj = function (e) {
            ...
            return (
                Object.keys(e).forEach(function (o) {
                    "string" == typeof e[o] ? (t[o] = "") : "boolean" == typeof e[o] && (t[o] = !1);
                }),
                t
            );
        }),
            (t.clicked = function (e, t, o, r) {
                var n = o.x - 5,
                    i = o.x + 5,
                    l = o.y - 5,
                    s = o.y + 5,
        ...
        (t.memoize = function e(t, o) {
            if ("function" != typeof t || (o && "function" != typeof o)) throw new TypeError("memoize: First argument must be a function");
            var r = function e() {
                for (var r = arguments.length, n = Array(r), i = 0; i < r; i++) n[i] = arguments[i];
                var a = o ? o.apply(e, n) : n[0],
                    l = e.cache;
                if (l.has(a)) return l.get(a);
                var s = t.apply(e, n);
                return (e.cache = l.set(a, s)), s;
            };
            return (r.cache = new e.Cache()), r;
        }).Cache = Map;
    },
    function (e) {
                ...
                var n =
                    ...
                    a = (function () {
                        function e() {
                            var t = this;
                            r(this, e);
                            var o = { extension: ".lang", location: "assets/lang/", langs: ["en-US"], locale: "en-US", preloaded: {} };
                            this.init = function (e) {
                                return (t.config = Object.assign({}, o, e)), (t.langs = Object.assign({}, t.config.preloaded)), (t.locale = t.config.locale || t.config.langs[0]), t.setCurrent(t.locale);
                            };
                        }
                        return (
                            (e.prototype.getValue = function (e) {
                                return (this.current && this.current[e]) || e;
                            }),
                            ...
                            (e.prototype.get = function (e, t) {
                                var o,
                                    ...
                                    a = i.match(/\{[^\}]+?\}/g);
                                if (t && a)
                                    if ("object" === (void 0 === t ? "undefined" : n(t))) for (var l = 0; l < a.length; l++) (o = a[l].substring(1, a[l].length - 1)), (i = i.replace(r.makeSafe(a[l]), t[o] || ""));
                                    else i = i.replace(/\{[^\}]+?\}/g, t);
                                return i;
                            }),
                            (e.prototype.fromFile = function (e) {
                                for (var t, o = e.split("\n"), r = {}, n = 0; n < o.length; n++)
                                    if ((t = o[n].match(/^(.+?) *?= *?([^\n]+)/))) {
                                        var i = t[2].replace(/^\s+|\s+$/, "");
                                        r[t[1]] = i;
                                    }
                                return r;
                            }),
                            ...
                            (e.prototype.loadLang = function (e) {
                                ...
                                return new Promise(function (o, r) {
                                    if (t.langs[e]) o(t.langs[e]);
                                    else {
                                        var n = new XMLHttpRequest(),
                                            i = t.config.location + e + t.config.extension;
                                        n.open("GET", i, !0),
                                            (n.onload = function () {
                                                if (304 >= this.status) {
                                                    var i = t.processFile(n.responseText);
                                                    (t.langs[e] = i), o(i);
                                                } else r({ status: this.status, statusText: n.statusText });
                                            }),
                                            (n.onerror = function () {
                                                r({ status: this.status, statusText: n.statusText });
                                            }),
                                            ...
                                            function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            return (e.next = 2), this.loadLang(t);
                                                        case 2:
                                                            return (this.locale = t), (this.current = this.langs[t]), e.abrupt("return", this.current);
                                                        case 5:
                                                        case "end":
                                                            return e.stop();
                                                    }
    ...
    function (e, t) {
        ...
        var o = {
                ...
                onAdd: function () {},
                onUpdate: function (e) {
                    r.opts.debug && console.log(e);
                },
                onSave: function () {},
                confirmClearAll: function (e) {
                    window.confirm(e.confirmationMessage) && e.clearAllAction(e);
                },
            },
            r = {
                init: function (e) {
                    return (this.opts = Object.assign({}, o, e)), this;
                },
                formeoSaved: new CustomEvent("formeoSaved", {}),
                formeoUpdated: new CustomEvent("formeoUpdated", {}),
            };
        document.addEventListener("formeoUpdated", function (e) {
            var t = e.timeStamp,
                o = e.type,
                n = e.data;
            r.opts.onUpdate({ timeStamp: t, type: o, data: n });
        }),
            document.addEventListener("confirmClearAll", function (e) {
                (e = { timeStamp: e.timeStamp, type: e.type, rowCount: e.detail.rows.length, confirmationMessage: e.detail.confirmationMessage, clearAllAction: e.detail.clearAllAction, btnCoords: e.detail.btnCoords }),
                    r.opts.confirmClearAll(e);
            }),
            document.addEventListener("formeoSaved", function (e) {
                (e = { timeStamp: e.timeStamp, type: e.type, formData: e.detail.formData }), r.opts.onSave(e);
            }),
            document.addEventListener("formeoLoaded", function (e) {
                r.opts.formeoLoaded(e.detail.formeo);
            }),
            (t.default = r);
    },
    function (e, t, o) {
        ...
        !(function (i) {
            "use strict";
            (r = i), void 0 !== (n = "function" == typeof r ? r.call(t, o, t, e) : r) && (e.exports = n);
        })(function () {
            "use strict";
            function e(e, t) {
                if (!e || !e.nodeType || 1 !== e.nodeType) throw "Sortable: `el` must be HTMLElement, and not " + {}.toString.call(e);
                (this.el = e), (this.options = t = b({}, t)), (e[R] = this);
                var o = {
                    group: Math.random(),
                    sort: !0,
                    disabled: !1,
                ...
                for (var r in o) r in t || (t[r] = o[r]);
                for (var i in (V(t), this)) "_" === i.charAt(0) && (this[i] = this[i].bind(this));
                (this.nativeDraggable = !t.forceFallback && W),
            ...
            function t(e) {
                x && x.state !== e && (l(x, "display", e ? "none" : ""), !e && x.state && _.insertBefore(x, v), (x.state = e));
            }
            function o(e, t, o) {
                if (e) {
                    (o = o || z), (t = t.split("."));
                    var r = t.shift().toUpperCase(),
                        n = new RegExp("\\s(" + t.join("|") + ")(?=\\s)", "g");
                    do {
                        if ((">*" === r && e.parentNode === o) || (("" === r || e.nodeName.toUpperCase() == r) && (!t.length || ((" " + e.className + " ").match(n) || []).length == t.length))) return e;
            ...
            function a(e, t, o) {
                if (e)
                    if (e.classList) e.classList[o ? "add" : "remove"](t);
                        ...
                        e.className = (r + (o ? " " + t : "")).replace(P, " ");
                    }
            }
            function l(e, t, o) {
                var r = e && e.style;
                if (r) {
                    if (void 0 === o) return z.defaultView && z.defaultView.getComputedStyle ? (o = z.defaultView.getComputedStyle(e, "")) : e.currentStyle && (o = e.currentStyle), void 0 === t ? o : o[t];
                    t in r || (t = "-webkit-" + t), (r[t] = o + ("string" == typeof o ? "" : "px"));
                }
            }
            function s(e, t, o) {
                if (e) {
                    var r = e.getElementsByTagName(t),
                        n = 0,
                        i = r.length;
                    if (o) for (; n < i; n++) o(r[n], n);
                    return r;
                }
                return [];
            }
            function d(e, t, o, r, n, i, a) {
                var l = z.createEvent("Event"),
                    s = (e || t[R]).options,
                    d = "on" + o.charAt(0).toUpperCase() + o.substr(1);
                l.initEvent(o, !0, !0), (l.to = t), (l.from = n || t), (l.item = r || t), (l.clone = x), (l.oldIndex = i), (l.newIndex = a), t.dispatchEvent(l), s[d] && s[d].call(e, l);
            }
            function f(e, t, o, r, n, i) {
                var a,
                    l,
                    s = e[R],
                    d = s.options.onMove;
            ...
            function p(e, t) {
                ...
                return (5 < t.clientY - (r.top + r.height) || 5 < t.clientX - (r.right + r.width)) && o;
            }
            function m(e) {
                for (var t = e.tagName + e.className + e.src + e.href + e.textContent, o = t.length, r = 0; o--; ) r += t.charCodeAt(o);
            ...
            function h(e, t) {
                ...
                return function () {
                    void 0 == o &&
                        ...
                        (r = this),
                        setTimeout(function () {
                            1 === o.length ? e.call(r, o[0]) : e.apply(r, o), (o = void 0);
                        }, t));
                };
            }
            function b(e, t) {
            ...
            var v,
                ...
                z = B.document,
                F = B.parseInt,
                W = !!("draggable" in z.createElement("div")),
                U = (function (e) {
                    return (e = z.createElement("x")), (e.style.cssText = "pointer-events:auto"), "auto" === e.style.pointerEvents;
                })(),
                G = !1,
                q = Math.abs,
                H = ([].slice, []),
                X = h(function (e, t, o) {
                    if (o && t.scroll) {
                        ...
                        if (k !== o && ((D = t.scroll), (k = o), !0 === D)) {
                            D = o;
                            do {
                                if (D.offsetWidth < D.scrollWidth || D.offsetHeight < D.scrollHeight) break;
                            } while ((D = D.parentNode));
                        }
                        D && ((r = D), (n = D.getBoundingClientRect()), (i = (q(n.right - d) <= l) - (q(n.left - d) <= l)), (a = (q(n.bottom - f) <= l) - (q(n.top - f) <= l))),
                            i || a || ((i = (c - d <= l) - (d <= l)), (a = (u - f <= l) - (f <= l)), (i || a) && (r = B)),
                            (I.vx !== i || I.vy !== a || I.el !== r) &&
                                ((I.el = r),
                                (I.vx = i),
                                (I.vy = a),
                                clearInterval(I.pid),
                                r &&
                                    (I.pid = setInterval(function () {
                                        r === B ? B.scrollTo(B.pageXOffset + i * s, B.pageYOffset + a * s) : (a && (r.scrollTop += a * s), i && (r.scrollLeft += i * s));
                                    }, 24)));
                    }
                }, 30),
                V = function (e) {
                    var t = e.group;
                    (t && "object" == typeof t) || (t = e.group = { name: t }),
                ...
                (e.prototype = {
                    ...
                    _onTapStart: function (e) {
                        var t = this,
                            ...
                            s = l,
                            f = n.filter;
                        if (!(("mousedown" === i && 0 !== e.button) || n.disabled || !(l = o(l, n.draggable, r)))) {
                            if (((S = g(l)), "function" == typeof f)) {
                                if (f.call(this, e, l, this)) return d(t, s, "filter", l, r, S), void e.preventDefault();
                            } else if (
                                f &&
                                (f = f.split(",").some(function (e) {
                                    if ((e = o(s, e.trim(), r))) return d(t, e, "filter", l, r, S), !0;
                                }))
                            )
                                return void e.preventDefault();
                            (n.handle && !o(s, n.handle, r)) || this._prepareDragStart(e, a, l);
                        }
                    },
                    _prepareDragStart: function (e, t, o) {
                        ...
                        o &&
                            ...
                            (M = d.group),
                            (r = function () {
                                i._disableDelayedDrag(), (v.draggable = !0), a(v, i.options.chosenClass, !0), i._triggerDragStart(t);
                            }),
                            d.ignore.split(",").forEach(function (e) {
                                s(v, e.trim(), c);
                            }),
                            n(f, "mouseup", i._onDrop),
                            n(f, "touchend", i._onDrop),
                            n(f, "touchcancel", i._onDrop),
                            d.delay
                                ? (n(f, "mouseup", i._disableDelayedDrag),
                                  n(f, "touchend", i._disableDelayedDrag),
                                  n(f, "touchcancel", i._disableDelayedDrag),
                                  n(f, "mousemove", i._disableDelayedDrag),
                                  n(f, "touchmove", i._disableDelayedDrag),
                                  (i._dragStartTimer = setTimeout(r, d.delay)))
                                : r());
                    },
                    _disableDelayedDrag: function () {
                        ...
                        clearTimeout(this._dragStartTimer),
                            ...
                            i(e, "mousemove", this._disableDelayedDrag),
                            i(e, "touchmove", this._disableDelayedDrag);
                    },
                    _triggerDragStart: function (e) {
                        e ? ((L = { target: v, clientX: e.clientX, clientY: e.clientY }), this._onDragStart(L, "touch")) : this.nativeDraggable ? (n(v, "dragend", this), n(_, "dragstart", this._onDragStart)) : this._onDragStart(L, !0);
                        try {
                            z.selection ? z.selection.empty() : window.getSelection().removeAllRanges();
                        } catch (e) {}
                    },
                    _dragStarted: function () {
                        _ && v && (a(v, this.options.ghostClass, !0), (e.active = this), d(this, _, "start", v, _, S));
                    },
                    _emulateDragOver: function () {
                        if (A) {
                            if (this._lastX === A.clientX && this._lastY === A.clientY) return;
                            (this._lastX = A.clientX), (this._lastY = A.clientY), U || l(w, "display", "none");
                            var e = z.elementFromPoint(A.clientX, A.clientY),
                                t = e,
                                o = " " + this.options.group.name,
                                r = H.length;
                            if (t)
                                do {
                                    if (t[R] && -1 < t[R].options.groups.indexOf(o)) {
                                        for (; r--; ) H[r]({ clientX: A.clientX, clientY: A.clientY, target: e, rootEl: t });
                                        break;
                                    }
                                    e = t;
                    ...
                    _onTouchMove: function (t) {
                        if (L) {
                            ...
                            var o = t.touches ? t.touches[0] : t,
                                r = o.clientX - L.clientX,
                                n = o.clientY - L.clientY,
                                i = t.touches ? "translate3d(" + r + "px," + n + "px,0)" : "translate(" + r + "px," + n + "px)";
                            (j = !0), (A = o), l(w, "webkitTransform", i), l(w, "mozTransform", i), l(w, "msTransform", i), l(w, "transform", i), t.preventDefault();
                        }
                    },
                    _appendGhost: function () {
                        if (!w) {
                            ...
                            (w = v.cloneNode(!0)),
                                a(w, r.ghostClass, !1),
                                a(w, r.fallbackClass, !0),
                                l(w, "top", t.top - F(o.marginTop, 10)),
                                l(w, "left", t.left - F(o.marginLeft, 10)),
                                l(w, "width", t.width),
                                l(w, "height", t.height),
                                l(w, "opacity", "0.8"),
                                l(w, "position", "fixed"),
                                l(w, "zIndex", "100000"),
                                l(w, "pointerEvents", "none"),
                                (r.fallbackOnBody && z.body.appendChild(w)) || _.appendChild(w),
                                (e = w.getBoundingClientRect()),
                                l(w, "width", 2 * t.width - e.width),
                                l(w, "height", 2 * t.height - e.height);
                        }
                    },
                    _onDragStart: function (e, t) {
                        var o = e.dataTransfer,
                            r = this.options;
                        this._offUpEvents(),
                            "clone" == M.pull && ((x = v.cloneNode(!0)), l(x, "display", "none"), _.insertBefore(x, v)),
                            t
                                ? ("touch" === t ? (n(z, "touchmove", this._onTouchMove), n(z, "touchend", this._onDrop), n(z, "touchcancel", this._onDrop)) : (n(z, "mousemove", this._onTouchMove), n(z, "mouseup", this._onDrop)),
                                  (this._loopId = setInterval(this._emulateDragOver, 50)))
                                : (o && ((o.effectAllowed = "move"), r.setData && r.setData.call(this, o, v)), n(z, "drop", this), setTimeout(this._dragStarted, 0));
                    },
                    _onDragOver: function (e) {
                        var r,
                            ...
                            g = s.sort;
                        if (
                            (void 0 !== e.preventDefault && (e.preventDefault(), !s.dragoverBubble && e.stopPropagation()),
                            (j = !0),
                            M && !s.disabled && (m ? g || (i = !_.contains(v)) : M.pull && c && (M.name === d.name || (c.indexOf && ~c.indexOf(M.name)))) && (void 0 === e.rootEl || e.rootEl === this.el))
                        ) {
                            if ((X(e, s, this.el), G)) return;
                            if (((r = o(e.target, s.draggable, a)), (n = v.getBoundingClientRect()), i)) return t(!0), void (x || E ? _.insertBefore(v, x || E) : !g && _.appendChild(v));
                            if (0 === a.children.length || a.children[0] === w || (a === e.target && (r = p(a, e)))) {
                                if (r) {
                                    if (r.animated) return;
                                    b = r.getBoundingClientRect();
                                }
                                t(m), !1 !== f(_, a, v, n, r, b) && (!v.contains(a) && (a.appendChild(v), (y = a)), this._animate(n, v), r && this._animate(b, r));
                            } else if (r && !r.animated && r !== v && void 0 !== r.parentNode[R]) {
                                C !== r && ((C = r), (O = l(r)), (T = l(r.parentNode)));
                                var h,
                                    b = r.getBoundingClientRect(),
                                    D = b.right - b.left,
                                    k = b.bottom - b.top,
                                    S = /left|right|inline/.test(O.cssFloat + O.display) || ("flex" == T.display && 0 === T["flex-direction"].indexOf("row")),
                                    N = r.offsetWidth > v.offsetWidth,
                                    L = r.offsetHeight > v.offsetHeight,
                                    A = 0.5 < (S ? (e.clientX - b.left) / D : (e.clientY - b.top) / k),
                                    I = r.nextElementSibling,
                                    P = f(_, a, v, n, r, b);
                                if (!1 !== P) {
                                    if (((G = !0), setTimeout(u, 30), t(m), 1 === P || -1 === P)) h = 1 === P;
                                    else if (S) {
                                        var B = v.offsetTop,
                                            z = r.offsetTop;
                                        h = B === z ? (r.previousElementSibling === v && !N) || (A && N) : z > B;
                                    } else h = (I !== v && !L) || (A && L);
                                    v.contains(a) || (h && !I ? a.appendChild(v) : r.parentNode.insertBefore(v, h ? I : r)), (y = v.parentNode), this._animate(n, v), this._animate(b, r);
                                }
                            }
                        }
                    },
                    _animate: function (e, t) {
                        ...
                        if (o) {
                            ...
                            l(t, "transition", "none"),
                                l(t, "transform", "translate3d(" + (e.left - r.left) + "px," + (e.top - r.top) + "px,0)"),
                                t.offsetWidth,
                                l(t, "transition", "all " + o + "ms"),
                    ...
                    _offUpEvents: function () {
                        var e = this.el.ownerDocument;
                        i(z, "touchmove", this._onTouchMove), i(e, "mouseup", this._onDrop), i(e, "touchend", this._onDrop), i(e, "touchcancel", this._onDrop);
                    },
                    _onDrop: function (t) {
                        var o = this.el,
                            r = this.options;
                        clearInterval(this._loopId),
                            clearInterval(I.pid),
                            clearTimeout(this._dragStartTimer),
                            i(z, "mousemove", this._onTouchMove),
                            this.nativeDraggable && (i(z, "drop", this), i(o, "dragstart", this._onDragStart)),
                            this._offUpEvents(),
                            t &&
                                (j && (t.preventDefault(), !r.dropBubble && t.stopPropagation()),
                                w && w.parentNode.removeChild(w),
                                v &&
                                    (this.nativeDraggable && i(v, "dragend", this),
                                    c(v),
                                    a(v, this.options.ghostClass, !1),
                                    a(v, this.options.chosenClass, !1),
                                    _ === y
                                        ? (x && x.parentNode.removeChild(x), v.nextSibling !== E && 0 <= (N = g(v)) && (d(this, _, "update", v, _, S, N), d(this, _, "sort", v, _, S, N)))
                                        : 0 <= (N = g(v)) && (d(null, y, "sort", v, _, S, N), d(this, _, "sort", v, _, S, N), d(null, y, "add", v, _, S, N), d(this, _, "remove", v, _, S, N)),
                                    e.active && ((null === N || -1 === N) && (N = S), d(this, _, "end", v, _, S, N), this.save())),
                                (_ = v = y = w = E = x = D = k = L = A = j = N = C = O = M = e.active = null));
                    },
                    handleEvent: function (e) {
                        var t = e.type;
                        "dragover" === t || "dragenter" === t ? v && (this._onDragOver(e), r(e)) : ("drop" === t || "dragend" === t) && this._onDrop(e);
                    },
                    toArray: function () {
                        for (var e, t = [], r = this.el.children, n = 0, i = r.length, a = this.options; n < i; n++) (e = r[n]), o(e, a.draggable, this.el) && t.push(e.getAttribute(a.dataIdAttr) || m(e));
                        return t;
                    },
                    sort: function (e) {
                        var t = {},
                        ...
                        this.toArray().forEach(function (e, n) {
                            var i = r.children[n];
                            o(i, this.options.draggable, r) && (t[e] = i);
                        }, this),
                    ...
                    closest: function (e, t) {
                        return o(e, t || this.options.draggable, this.el);
                    },
                    option: function (e, t) {
                        var o = this.options;
                        return void 0 === t ? o[e] : ((o[e] = t), void ("group" === e && V(o)));
                    },
                    destroy: function () {
                        var e = this.el;
                        (e[R] = null),
    ...
    function (e, t) {
        ...
        var o = {
                add: {
                    attr: function (e) {
                        var t,
                            o = window.prompt(e.message.attr);
                        o && ((t = window.prompt(e.message.value, "") + ""), e.addAction(o, t));
                    },
                    option: function (e) {
                        e.addAction();
                    },
    ...
    function (e, t) {
        ...
        var r =
                ...
                return (
                    (e.prototype.add = function (e, t) {
                        var o = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : window,
                            r = this;
                        (r[e] = r[e] || { callbacks: [] }), r.addCallback(e, t);
                        var n = function (t) {
                            r.throttle(r[e], t);
                        };
                        return o.addEventListener(e, n), n;
                    }),
                    (e.prototype.addCallback = function (e, t) {
                        var o = this;
                        t && o[e].callbacks.push(t);
                    }),
                    ...
                    (e.prototype.throttle = function (e, t) {
                        ...
                        e.running ||
                            ...
                            window.requestAnimationFrame
                                ...
                                : setTimeout(o.runCallbacks.bind(e), 66));
                    }),
                    e
                );
            })()),
            {
                ...
                fadeOut: function (e) {
                    var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 250;
                    (e.style.opacity = 1),
                        (function o() {
                            var r = +e.style.opacity - 1 / (t / 60);
                            0 < r ? ((e.style.opacity = r), requestAnimationFrame(o)) : e.remove();
                        })();
                },
                slideDown: function (e) {
                    ...
                    (e.style.height = "0px"),
                        (function r() {
                            var n = parseFloat(e.style.height);
                            n < a ? ((e.style.height = n + a / (t / 60) + "px"), requestAnimationFrame(r)) : ((e.style.overflow = i), (e.style.height = "auto"), o && o(e));
                        })();
                },
                slideUp: function (e) {
                    var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 250,
                        ...
                        i = parseInt(n.height),
                        a = n.overflow;
                    (e.style.overflow = "hidden"), (e.style.height = i + "px");
                    var l = n.minHeight;
                    e.style.minHeight = "auto";
                    var s = parseFloat(i / (t / 60)).toFixed(2);
                    !(function t() {
                        var r = parseInt(e.style.height, 10),
                            n = r - s;
                        0 < n ? ((e.style.height = n + "px"), requestAnimationFrame(t)) : ((e.style.overflow = a), (e.style.display = "none"), (e.style.minHeight = l), delete e.style.height, o && o(e));
                    })();
                },
                slideToggle: function (e) {
                    var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 250;
                    "none" === r.getStyle(e, "display") ? r.slideDown(e, t) : r.slideUp(e, t);
                },
            });
        t.default = r;
    },
        ...
        var i = o(4),
            ...
            g = (function () {
                function e(t) {
                    n(this, e);
                    var o = this;
                    (o.opts = Object.assign({}, m, t)), (o.labels = o.panelNav());
                    var r = o.panelsWrap();
                    return (
                        (o.panels = r.childNodes),
                        (o.currentPanel = o.panels[0]),
                        (o.nav = o.navActions()),
                        "field" === o.opts.type && setTimeout(o.setPanelsHeight.bind(o), 100),
                        (o.panelDisplay = "slider"),
                        { content: [o.labels, r], nav: o.nav, actions: { resize: o.resizePanels.bind(o) } }
                    );
                }
                return (
                    (e.prototype.resizePanels = function () {
                        var e = this.panelsWrap,
                            t = e.parentElement.parentElement,
                            o = parseInt(u.default.getStyle(t, "width")),
                            r = 390 < o;
                        (this.panelDisplay = r ? "tabbed" : "slider"), e.parentElement.classList.toggle("tabbed-panels", r);
                        var n = e.style,
                            i = u.default.getStyle(this.currentPanel, "height");
                        return (n.height = i);
                    }),
                    (e.prototype.setPanelsHeight = function () {
                        var e = document.getElementById(this.opts.id);
                        (this.slideToggle = e.querySelector(".field-edit")),
                    ...
                    (e.prototype.panelsWrap = function () {
                        return (
                            (this.panelsWrap = u.default.create({ tag: "div", attrs: { className: "panels" }, content: this.opts.panels })),
                            (this.panelsWrap = this.panelsWrap),
                            "field" === this.opts.type && this.sortableProperties(this.panelsWrap),
                            this.panelsWrap
                        );
                    }),
                    (e.prototype.sortableProperties = function (e) {
                        var t = this,
                            o = e.getElementsByClassName("field-edit-group");
                        return f.default.forEach(o, function (e) {
                            (e.fieldID = t.opts.id),
                                e.isSortable &&
                                    s.default.create(e, {
                                        animation: 150,
                                        group: { name: "edit-" + e.editGroup, pull: !0, put: ["properties"] },
                                        sort: !0,
                                        handle: ".prop-order",
                                        onSort: function (e) {
                                            t.propertySave(e.to), t.resizePanels();
                                        },
                                    });
                        });
                    }),
                    (e.prototype.propertySave = function (e) {
                        var t = u.default.fields.get(this.opts.id);
                        return p.data.save(e.editGroup, e, !1), t.instance.updatePreview();
                    }),
                    (e.prototype.panelNav = function () {
                        for (var e, t = this, o = this, r = { tag: "div", attrs: { className: "panel-labels" }, content: { tag: "div", content: [] } }, n = this.opts.panels, i = 0; i < n.length; i++)
                            (e = {
                                tag: "h5",
                                action: {
                                    click: function (e) {
                                        var t = f.default.indexOfNode(e.target, e.target.parentElement);
                                        o.currentPanel = o.panels[t];
                                        var r = e.target.parentElement.childNodes;
                                        o.nav.refresh(t), u.default.removeClasses(r, "active-tab"), e.target.classList.add("active-tab");
                                    },
                                },
                                content: n[i].config.label,
                            }),
                                delete n[i].config.label,
                                0 === i && (e.className = "active-tab"),
                                r.content.content.push(e);
                        var l = {
                                tag: "button",
                                attrs: { className: "next-group", title: a.default.get("controlGroups.nextGroup"), type: "button" },
                                dataset: { toggle: "tooltip", placement: "top" },
                                action: {
                                    click: function (e) {
                                        return t.nav.nextGroup(e);
                                    },
                                },
                                content: u.default.icon("triangle-right"),
                            },
                            s = {
                                tag: "button",
                                attrs: { className: "prev-group", title: a.default.get("controlGroups.prevGroup"), type: "button" },
                                dataset: { toggle: "tooltip", placement: "top" },
                                action: {
                                    click: function (e) {
                                        return t.nav.prevGroup(e);
                                    },
                                },
                                content: u.default.icon("triangle-left"),
                            };
                        return u.default.create({ tag: "nav", attrs: { className: "panel-nav" }, content: [s, r, l] });
                    }),
                    (e.prototype.navActions = function () {
                        var e = this,
                            t = this,
                            o = {},
                            r = this.currentPanel.parentElement,
                            n = this.labels.querySelector(".panel-labels").firstChild,
                            i = this.currentPanel.parentElement.childNodes,
                            a = f.default.indexOfNode(this.currentPanel, r),
                            l = {},
                            s = function (t) {
                                return (e.currentPanel = i[t]), (e.panelsWrap.style.height = u.default.getStyle(e.currentPanel, "height")), "field" === e.opts.type && (e.slideToggle.style.height = "auto"), e.currentPanel;
                            },
                            d = function (e) {
                                "tabbed" === t.panelDisplay ? n.removeAttribute("style") : (n.style.transform = "translateX(-" + e.nav + "px)"), (r.style.transform = "translateX(-" + e.panel + "px)");
                            };
                        return (
                            (o.refresh = function (e) {
                                void 0 !== e && ((a = e), s(e)), t.resizePanels(), (l = { nav: n.offsetWidth * a, panel: r.offsetWidth * a }), d(l);
                            }),
                            (o.nextGroup = function () {
                                var t = a + 1;
                                if (t !== i.length) (l = { nav: n.offsetWidth * t, panel: r.offsetWidth * t }), d(l), s(t), a++;
                                else {
                                    var o = { nav: n.style.transform, panel: r.style.transform };
                                    (l = { nav: n.offsetWidth * a + 10, panel: r.offsetWidth * a + 10 }),
                                        d(l),
                                        setTimeout(function () {
                                            (n.style.transform = o.nav), (r.style.transform = o.panel);
                                        }, 150);
                                }
                                return e.currentPanel;
                            }),
                            (o.prevGroup = function () {
                                if (0 !== a) {
                                    var e = a - 1;
                                    (l = { nav: n.offsetWidth * e, panel: r.offsetWidth * e }), d(l), s(e), a--;
                                } else {
                                    var t = [n.style.transform, r.style.transform],
                                        o = "translateX(10px)";
                                    (n.style.transform = o),
                                        (r.style.transform = o),
                                        setTimeout(function () {
                                            (n.style.transform = t[0]), (r.style.transform = t[1]);
                                        }, 150);
                                }
                            }),
                            o
    ...
    function (e, t, o) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), o(19);
        var a = o(4),
            l = r(a),
            s = o(1),
            d = r(s),
            ...
            _ = (function () {
                function e(t, o) {
                    ...
                    var r = {
                        ...
                        n = window.sessionStorage.getItem("formeo-locale");
                    n && (r.i18n.locale = n);
                    var a = this;
                    return (
                        (a.container = t.container || r.container),
                        "string" == typeof a.container && (a.container = document.querySelector(a.container)),
                        delete t.container,
                        (x = d.default.merge(r, t)),
                        f.data.init(x, o),
                        u.default.init(x.events),
                        m.default.init(x.actions),
                        a.loadResources().then(function () {
                            (h.default.setConfig = x.config),
                                (w.render = function (e) {
                                    return h.default.renderForm.call(h.default, e);
                                }),
                                x.allowEdit && ((w.edit = a.init.bind(a)), a.init.call(a));
                        }),
                        w
                    );
                }
                return (
                    (e.prototype.loadResources = function () {
                        var e = [];
                        return x.style && e.push(d.default.ajax(x.style, d.default.insertStyle)), x.svgSprite && e.push(d.default.ajax(x.svgSprite, d.default.insertIcons)), window.Promise.all(e);
                    }),
                                ...
                                return regeneratorRuntime.wrap(
                                    function (e) {
                                        for (;;)
                                            switch ((e.prev = e.next)) {
                                                case 0:
                                                    return (t = this), (e.next = 3), l.default.init(x.i18n);
                                                case 3:
                                                    return (
                                                        (t.formID = f.formData.id),
                                                        (w.controls = new b.Controls(x.controls, t.formID)),
                                                        (t.stages = t.buildStages()),
                                                        (w.i18n = {
                                                            setLang: function (e) {
                                                                window.sessionStorage.setItem("formeo-locale", e),
                                                                    l.default.setCurrent.call(l.default, e).then(
                                                                        function () {
                                                                            (t.stages = t.buildStages()), (w.controls = new b.Controls(x.controls, t.formID)), t.render();
                                                                        },
                                                                        function (e) {
                                                                            (e.message = "There was an error retrieving the language files"), console.error(e);
                                                                        }
                                                                    );
                                                            },
                                                        }),
                    ...
                    (e.prototype.buildStages = function () {
                        var e = [],
                            t = function (e) {
                                return new y.default(x, e);
                            };
                        return (
                            f.formData.stages.size
                                ? f.formData.stages.forEach(function (o, r) {
                                      e.push(t(r));
                                  })
                                : e.push(t()),
                            e
                    ...
                    (e.prototype.render = function () {
                        var e = this,
                            t = w.controls.element,
                            o = { tag: "div", attrs: { className: "formeo formeo-editor", id: e.formID }, content: [e.stages, t] };
                        l.default.current.dir && ((o.attrs.dir = l.default.current.dir), (h.default.dir = l.default.current.dir));
                        var r = h.default.create(o);
                        (e.container.innerHTML = ""),
                            e.container.appendChild(r),
                            e.stages.forEach(function (e) {
                                e.childNodes[0].style.minHeight = h.default.getStyle(t, "height");
                            }),
                            (u.default.formeoLoaded = new CustomEvent("formeoLoaded", { detail: { formeo: w } })),
                            document.dispatchEvent(u.default.formeoLoaded);
                    }),
                    e
                );
            })();
        void 0 !== window && (window.Formeo = _), (t.default = _);
    },
    function (e, t, o) {
        (function (t, o) {
            !(function (t) {
                "use strict";
                function r(e, t, o, r) {
                    var n = Object.create((t || i).prototype),
                        a = new m(r || []);
                    return (n._invoke = c(e, o, a)), n;
                }
                function n(e, t, o) {
                    try {
                ...
                function f(e) {
                    function t(t, o) {
                        ...
                        return a instanceof d
                            ? Promise.resolve(a.arg).then(n, i)
                ...
                function c(e, t, o) {
                    ...
                    return function (i, a) {
                        ...
                        for (;;) {
                            var l = o.delegate;
                            if (l) {
                                if ("return" === i || ("throw" === i && l.iterator[i] === b)) {
                                    o.delegate = null;
                                    var s = l.iterator.return;
                                    if (s) {
                                        var d = n(s, l.iterator, a);
                                        if ("throw" === d.type) {
                                            (i = "throw"), (a = d.arg);
                                            continue;
                                        }
                                ...
                                var d = n(l.iterator[i], l.iterator, a);
                                if ("throw" === d.type) {
                                    (o.delegate = null), (i = "throw"), (a = d.arg);
                                    continue;
                                }
                                (i = "next"), (a = b);
                                var f = d.arg;
                                if (!f.done) return (r = E), f;
                                (o[l.resultName] = f.value), (o.next = l.nextLoc), (o.delegate = null);
                            }
                            if ("next" === i) (o._sent = a), (o.sent = r == E ? a : b);
                            else if ("throw" === i) {
                                if (r == _) throw ((r = k), a);
                                o.dispatchException(a) && ((i = "next"), (a = b));
                            } else "return" === i && o.abrupt("return", a);
                            r = D;
                            var d = n(e, t, o);
                            if ("normal" === d.type) {
                                r = o.done ? k : E;
                                var f = { value: d.arg, done: o.done };
                                if (d.arg !== C) return f;
                                o.delegate && "next" === i && (a = b);
                            } else "throw" === d.type && ((r = k), (i = "throw"), (a = d.arg));
                        }
                    };
                }
                function u(e) {
                ...
                function g(e) {
                    if (e) {
                        ...
                        if (!isNaN(e.length)) {
                            var o = -1,
                                r = function t() {
                                    for (; ++o < e.length; ) if (v.call(e, o)) return (t.value = e[o]), (t.done = !1), t;
                ...
                var _ = "suspendedStart",
                    ...
                    k = "completed",
                    C = {},
                    O = (l.prototype = i.prototype);
                (a.prototype = O.constructor = l),
                    (l.constructor = a),
                    ...
                    (x.mark = function (e) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(e, l) : (e.__proto__ = l), (e.prototype = Object.create(O)), e;
                    }),
                    (x.awrap = function (e) {
                        return new d(e);
                    }),
                    s(f.prototype),
                    (x.async = function (e, t, o, n) {
                        var i = new f(r(e, t, o, n));
                    ...
                    (m.prototype = {
                        ...
                        reset: function (e) {
                            if (((this.prev = 0), (this.next = 0), (this.sent = b), (this.done = !1), (this.delegate = null), this.tryEntries.forEach(p), !e))
                                for (var t in this) "t" === t.charAt(0) && v.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = b);
                        },
                        stop: function () {
                            this.done = !0;
                        ...
                        dispatchException: function (e) {
                            function t(t, r) {
                                return (i.type = "throw"), (i.arg = e), (o.next = t), !!r;
                            }
                        ...
                        abrupt: function (e, t) {
                            for (var o, r = this.tryEntries.length - 1; 0 <= r; --r)
                                if (((o = this.tryEntries[r]), o.tryLoc <= this.prev && v.call(o, "finallyLoc") && this.prev < o.finallyLoc)) {
                                    var n = o;
                                    break;
                                }
                            n && ("break" === e || "continue" === e) && n.tryLoc <= t && t <= n.finallyLoc && (n = null);
                            var i = n ? n.completion : {};
                            return (i.type = e), (i.arg = t), n ? (this.next = n.finallyLoc) : this.complete(i), C;
                        },
                        ...
                        finish: function (e) {
                            for (var t, o = this.tryEntries.length - 1; 0 <= o; --o) if (((t = this.tryEntries[o]), t.finallyLoc === e)) return this.complete(t.completion, t.afterLoc), p(t), C;
                        },
                        catch: function (e) {
                        ...
                        delegateYield: function (e, t, o) {
                            return (this.delegate = { iterator: g(e), resultName: t, nextLoc: o }), C;
                        },
                    });
        ...
        var i = o(4),
            ...
            b = (function () {
                function e(t) {
                    ...
                    var o,
                        r = this,
                        i = (r.columnID = t || (0, h.uuid)());
                    (r.columnData = d.formData.columns.get(i)), (o = { fields: [], id: i, config: {}, className: [] }), d.formData.columns.set(i, c.default.merge(o, r.columnData));
                    var l = { tag: "li", className: "resize-x-handle", action: { mousedown: r.resize, touchstart: r.resize }, content: [g.default.icon("triangle-down"), g.default.icon("triangle-up")] },
                        f = {
                            tag: "ul",
                            className: ["stage-columns", "empty-columns"],
                            dataset: { hoverTag: a.default.get("column") },
                            action: {
                                mouseup: function (e) {
                                    var t = e.target.parentElement;
                                    t.resizing && ((t.resizing = !1), t.parentElement.classList.remove("resizing-columns"));
                                },
                            },
                            id: r.columnID,
                            content: [g.default.actionButtons(r.columnID), { tag: "li", className: "column-edit group-config" }, l],
                            fType: "columns",
                        };
                    (f = g.default.create(f)), this.processConfig(f), (p.default.columnResized = new CustomEvent("columnResized", { detail: { column: f, instance: r } }));
                    var u = (this.sortable = s.default.create(f, {
                        animation: 150,
                        fallbackClass: "field-moving",
                        forceFallback: !0,
                        group: { name: "columns", pull: !0, put: ["columns", "controls"], revertClone: !0 },
                        sort: !0,
                        onEnd: r.onEnd,
                        onAdd: r.onAdd,
                        onSort: r.onSort,
                        onRemove: r.onRemove,
                        onMove: function (e) {
                            e.from !== e.to && e.from.classList.remove("hovering-column"), "columns" === e.related.parentElement.fType && e.related.parentElement.classList.add("hovering-column");
                        },
                        draggable: ".stage-fields",
                    }));
                    return g.default.columns.set(i, { column: f, sortable: u }), f;
                }
                return (
                    (e.prototype.onSort = function (e) {
                        return d.data.saveFieldOrder(e.target);
                    }),
                    (e.prototype.processConfig = function (e) {
                        var t = this,
                            o = d.formData.columns.get(t.columnID);
                        o.config.width && ((e.dataset.colWidth = o.config.width), (e.style.width = o.config.width), (e.style.float = "left"));
                    }),
                    (e.prototype.onAdd = function (e) {
                        var t = e.from,
                            ...
                            r = e.to,
                            n = "columns" === t.fType;
                        if ("controlGroup" === t.fType) {
                            var i = c.default.get(d.registeredFields[o.id], "meta");
                            if ("layout" !== i.group) {
                                var a = g.default.addField(r.id, o.id);
                                r.insertBefore(a, r.childNodes[e.newIndex]), d.data.saveFieldOrder(r), d.data.save("fields", r.id);
                            } else if ("layout-column" === i.id) {
                                var l = r.parentElement;
                                g.default.addColumn(l.id), g.default.columnWidths(l);
                            }
                            g.default.remove(e.item);
                        }
                        g.default.fieldOrderClass(r), n && g.default.fieldOrderClass(t), g.default.emptyClass(e.to), d.data.save(), r.classList.remove("hovering-column");
                    }),
                    (e.prototype.onRemove = function (e) {
                        e.from.parent && (g.default.columnWidths(e.from.parentElement), d.data.saveColumnOrder(e.from.parentElement)), g.default.emptyClass(e.from);
                    }),
                    (e.prototype.onEnd = function (e) {
                        var t = e.to,
                            o = e.from;
                        return o.classList.contains("empty-columns")
                            ? void g.default.removeEmpty(e.from)
                            : (g.default.fieldOrderClass(t), g.default.fieldOrderClass(o), o.parent && g.default.columnWidths(o.parentElement), d.data.save(), void (t && t.classList.remove("hovering-column")));
                    }),
                    (e.prototype.resize = function (e) {
                        function t(e) {
                            var t = "touchmove" === e.type ? e.touches[0].clientX : e.clientX,
                                l = n.colStartWidth + t - n.startX,
                                s = n.sibStartWidth - t + n.startX,
                                d = function (e) {
                                    return (e / n.rowWidth) * 100;
                                };
                            (o = parseFloat(d(l))),
                                (r = parseFloat(d(s))),
                                (i.dataset.colWidth = (0, h.numToPercent)(o.toFixed(1))),
                                (a.dataset.colWidth = (0, h.numToPercent)(r.toFixed(1))),
                                (i.style.width = (0, h.numToPercent)(o)),
                                (a.style.width = (0, h.numToPercent)(r));
                        }
                        var o,
                            r,
                            n = {},
                            i = e.target.parentElement,
                            a = i.nextSibling || i.previousSibling,
                            l = i.parentElement,
                            s = g.default.getStyle(l),
                            f = parseFloat(s.paddingLeft) + parseFloat(s.paddingRight);
                        (n.move = function (e) {
                            t(e), (n.resized = !0);
                        }),
                            (n.stop = function () {
                                if (
                                    (window.removeEventListener("mousemove", n.move),
                                    window.removeEventListener("mouseup", n.stop),
                                    window.removeEventListener("touchmove", n.move),
                                    window.removeEventListener("touchend", n.stop),
                                    !!n.resized)
                                ) {
                                    var e = d.formData.columns.get(i.id),
                                        t = d.formData.columns.get(a.id),
                                        o = i.parentElement;
                                    (o.querySelector(".column-preset").value = "custom"), o.classList.remove("resizing-columns"), (e.config.width = i.dataset.colWidth), (t.config.width = a.dataset.colWidth), (n.resized = !1), d.data.save();
                                }
                            }),
                            (n.start = (function (e) {
                                (n.startX = "touchstart" === e.type ? e.touches[0].clientX : e.clientX), l.classList.add("resizing-columns");
                                var t = /\bcol-\w+-\d+/g;
                                i.className.replace(t, ""),
                                    a.className.replace(t, ""),
                                    (n.colStartWidth = i.offsetWidth || g.default.getStyle(i, "width")),
                                    (n.sibStartWidth = a.offsetWidth || g.default.getStyle(a, "width")),
                                    (n.rowWidth = l.offsetWidth - f),
                                    window.addEventListener("mouseup", n.stop, !1),
                                    window.addEventListener("mousemove", n.move, !1),
                                    window.addEventListener("touchend", n.stop, !1),
                                    window.addEventListener("touchmove", n.move, !1);
                            })(e));
                    }),
                    e
                );
    ...
    function (e, t, o) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), (t.Controls = void 0);
        var i = o(6),
            a = r(i),
            l = o(4),
            s = r(l),
        ...
        t.Controls = (function () {
            function e(t, o) {
                ...
                var i = t.groupOrder,
                    a = void 0 === i ? [] : i;
                (this.groupOrder = (0, m.unique)(a.concat(["common", "html", "layout"]))), (this.cPosition = {});
                var l = [
                    { tag: "div", config: { label: s.default.get("column") }, meta: { group: "layout", icon: "columns", id: "layout-column" } },
                    { tag: "div", config: { label: s.default.get("row") }, meta: { group: "layout", icon: "rows", id: "layout-row" } },
                    {
                        tag: "input",
                        attrs: { type: "text", required: !1, className: "" },
                        config: { disabledAttrs: ["type"], label: s.default.get("input.text") },
                        meta: { group: "common", icon: "text-input", id: "text-input" },
                        fMap: "attrs.value",
                    },
                    { tag: "input", attrs: { type: "date", required: !1, className: "" }, config: { disabledAttrs: ["type"], label: s.default.get("input.date") }, meta: { group: "common", icon: "calendar", id: "date-input" } },
                    {
                        tag: "button",
                        attrs: {
                            className: [
                                { label: s.default.get("grouped"), value: "f-btn-group" },
                                { label: s.default.get("ungrouped"), value: "f-field-group" },
                            ],
                        },
                        config: { label: s.default.get("button"), hideLabel: !0, disabledAttrs: ["type"] },
                        meta: { group: "common", icon: "button", id: "button" },
                        options: [
                            {
                                label: s.default.get("button"),
                                type: [
                                    { label: s.default.get("button"), value: "button", selected: !0 },
                                    { label: s.default.get("reset"), value: "reset" },
                                    { label: s.default.get("submit"), value: "submit" },
                                ],
                                className: [
                                    { label: s.default.get("default"), value: "", selected: !0 },
                                    { label: s.default.get("primary"), value: "primary" },
                                    { label: s.default.get("danger"), value: "error" },
                                    { label: s.default.get("success"), value: "success" },
                                    { label: s.default.get("warning"), value: "warning" },
                                ],
                            },
                        ],
                    },
                    {
                        tag: "select",
                        config: { label: s.default.get("select") },
                        attrs: { required: !1, className: "" },
                        meta: { group: "common", icon: "select", id: "select" },
                        options: [1, 2, 3, 4].map(function (e) {
                            return { label: s.default.get("labelCount", { label: s.default.get("option"), count: e }), value: "option-" + e, selected: !1 };
                        }),
                    },
                    { tag: "textarea", config: { label: s.default.get("textarea") }, meta: { group: "common", icon: "textarea", id: "textarea" }, attrs: { required: !1 } },
                    {
                        tag: "input",
                        attrs: { type: "checkbox", required: !1 },
                        config: { label: s.default.get("checkbox") + "/" + s.default.get("group"), disabledAttrs: ["type"] },
                        meta: { group: "common", icon: "checkbox", id: "checkbox" },
                        options: [{ label: s.default.get("labelCount", { label: s.default.get("checkbox"), count: 1 }), value: "checkbox-1", selected: !0 }],
                    },
                    {
                        tag: "input",
                        attrs: { type: "radio", required: !1 },
                        config: { label: s.default.get("radioGroup"), disabledAttrs: ["type"] },
                        meta: { group: "common", icon: "radio-group", id: "radio" },
                        options: [1, 2, 3].map(function (e) {
                            return { label: s.default.get("labelCount", { label: s.default.get("radio"), count: e }), value: "radio-" + e, selected: !1 };
                        }),
                    },
                    {
                        tag: "h1",
                        ...
                        config: { label: s.default.get("header"), editable: !0, hideLabel: !0 },
                        meta: { group: "html", icon: "header", id: "header" },
                        content: s.default.get("header"),
                    },
                    {
                        tag: "p",
                        attrs: { className: "" },
                        config: { label: s.default.get("paragraph"), hideLabel: !0, editable: !0 },
                        meta: { group: "html", icon: "paragraph", id: "paragraph" },
                        content:
                            "Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.",
                    },
                    { tag: "hr", config: { label: s.default.get("separator"), hideLabel: !0 }, meta: { group: "html", icon: "divider", id: "divider" } },
                    { tag: "input", attrs: { type: "file", required: !1 }, config: { disabledAttrs: ["type"], label: s.default.get("fileUpload") }, meta: { group: "common", icon: "upload", id: "upload" }, fMap: "attrs.value" },
                    { tag: "input", attrs: { type: "number", required: !1, className: "" }, config: { label: s.default.get("number"), disabledAttrs: ["type"] }, meta: { group: "common", icon: "hash", id: "number" }, fMap: "attrs.value" },
                    { tag: "input", attrs: { type: "hidden", value: "" }, config: { label: s.default.get("hidden"), hideLabel: !0 }, meta: { group: "common", icon: "hidden", id: "hidden" }, fMap: "attrs.value" },
                ];
                (this.defaults = {
                    sortable: !0,
                    elementOrder: {},
                    groups: [
                        { id: "layout", label: s.default.get("layout"), elementOrder: ["row", "column"] },
                        { id: "common", label: s.default.get("commonFields"), elementOrder: ["button", "checkbox"] },
                        { id: "html", label: s.default.get("htmlElements"), elementOrder: ["header", "block-text"] },
                    ],
                    disable: { groups: [], elements: [] },
                    elements: [],
                }),
                    (y = c.default.merge(this.defaults, t)),
                    (y.elements = y.elements.concat(l)),
                    (this.controlEvents = {
                        focus: function (e) {
                            var t = (0, m.closestFtype)(e.target);
                            r.panels.nav.refresh(c.default.indexOfNode(t));
                        },
                        click: function (e) {
                            return r.addElement(e.target.parentElement.id);
                        },
                    }),
                    this.buildDOM();
            }
            return (
                (e.prototype.applyControlEvents = function (e) {
                    for (var t, o = e.item, r = document.getElementById(o.id), n = r.querySelector("button"), i = Object.keys(this.controlEvents), a = i.length - 1; 0 <= a; a--) (t = i[a]), n.addEventListener(t, this.controlEvents[t]);
                }),
                (e.prototype.prepElement = function (e) {
                    var t = this,
                        o = (0, m.uuid)(),
                        r = { tag: "button", attrs: { type: "button" }, content: [e.config.label], action: t.controlEvents },
                        n = { tag: "li", className: ["field-control", e.meta.group + "-control", e.meta.id + "-control"], id: o, cPosition: {}, content: r };
                    return e.meta.icon && r.content.unshift(h.default.icon(e.meta.icon)), (d.registeredFields[o] = d.registeredFields[e.meta.id] = e), n;
                }),
                (e.prototype.groupElements = function () {
                    var e = this,
                        t = this,
                        o = y.groups.slice(),
                        r = y.elements.slice(),
                        n = [];
                    return (
                        (o = c.default.orderObjectsBy(o, this.groupOrder, "id")),
                        (o = o.filter(function (e) {
                            return (0, m.match)(e.id, y.disable.groups);
                        })),
                        c.default.map(o, function (i) {
                            var a = { tag: "ul", attrs: { className: "control-group", id: t.formID + "-" + o[i].id + "-control-group" }, fType: "controlGroup", config: { label: o[i].label || "" } };
                            if (y.elementOrder[o[i].id]) {
                                var l = y.elementOrder[o[i].id],
                                    s = (0, m.unique)(l.concat(o[i].elementOrder));
                                o[i].elementOrder = s;
                            }
                            return (
                                (r = c.default.orderObjectsBy(r, o[i].elementOrder, "meta.id")),
                                (a.content = r
                                    .filter(function (e) {
                                        var t = e.meta.id || "",
                                            r = [(0, m.match)(t, y.disable.elements), e.meta.group === o[i].id, !c.default.inArray(e.meta.id, n)],
                                            a = !0;
                                        return (
                ...
                (e.prototype.formActions = function () {
                    var e = { tag: "button", attrs: { type: "button" } };
                    return {
                        tag: "div",
                        className: "form-actions f-btn-group",
                        content: [
                            c.default.merge(e, {
                                content: [h.default.icon("bin"), s.default.get("clear")],
                                className: ["clear-form"],
                                attrs: { title: s.default.get("clearAll") },
                                action: {
                                    click: function (e) {
                                        d.formData.rows.size
                                            ? ((p.default.confirmClearAll = new CustomEvent("confirmClearAll", {
                                                  detail: {
                                                      confirmationMessage: s.default.get("confirmClearAll"),
                                                      clearAllAction: h.default.clearForm.bind(h.default),
                                                      btnCoords: h.default.coords(e.target),
                                                      rows: h.default.rows,
                                                      rowCount: h.default.rows.size,
                                                  },
                                              })),
                                              document.dispatchEvent(p.default.confirmClearAll))
                                            : alert("There are no fields to clear");
                                    },
                                },
                            }),
                            c.default.merge(e, {
                                content: [h.default.icon("floppy-disk"), s.default.get("save")],
                                attrs: { title: s.default.get("save") },
                                className: ["save-form"],
                                action: {
                                    click: function () {
                                        d.data.save();
                ...
                (e.prototype.buildDOM = function () {
                    ...
                    var r = ["control-groups", "panels-wrap", "panel-count-" + t.length],
                        ...
                        i = h.default.create({ tag: "div", className: this.formID + "-controls formeo-controls", content: [n, o] }),
                        l = i.getElementsByClassName("control-group");
                    (this.element = i),
                        (this.groups = l),
                        (this.currentGroup = l[0]),
                        (this.actions = {
                            filter: function (t) {
                                var o = e.panels.content[1],
                                    r = n.querySelector(".filtered-term"),
                                    a = o.querySelectorAll(".field-control");
                                if ((c.default.toggleElementsByStr(a, t), "" !== t)) {
                                    var l = "Filtering '" + t + "'";
                                    i.classList.add("filtered"), r ? (r.textContent = l) : ((r = h.default.create({ tag: "h5", className: "filtered-term", content: l })), n.insertBefore(r, n.firstChild));
                    ...
                    for (var s = l.length - 1; 0 <= s; s--)
                        !(function (t) {
                            ...
                            y.sortable || localStorage.removeItem(o),
                                a.default.create(l[t], {
                                    animation: 150,
                                    forceFallback: !0,
                                    fallbackClass: "control-moving",
                                    fallbackOnBody: !0,
                                    group: { name: "controls", pull: "clone", put: !1 },
                                    onRemove: e.applyControlEvents.bind(e),
                                    sort: y.sortable,
                                    store: {
                                        get: function () {
                ...
                (e.prototype.addElement = function (e) {
                    var t = h.default.addRow(),
                        o = c.default.get(d.registeredFields[e], "meta");
                    if ("layout" !== o.group) {
                        var r = h.default.addColumn(t.id);
                        h.default.addField(r.id, e);
                    } else "layout-column" === o.id && h.default.addColumn(t.id);
                    d.data.saveColumnOrder(t), h.default.columnWidths(t), d.data.save();
                }),
                e
            );
        })();
        ...
        var a = o(4),
            ...
            w = (function () {
                function e(t) {
                    i(this, e);
                    var o = this,
                        r = s.formData.fields.get(t) || (0, y.clone)(s.registeredFields[t]);
                    (o.fieldID = r.id || (0, y.uuid)()), (o.metaID = r.meta.id), (r.id = o.fieldID), s.formData.fields.set(o.fieldID, r), (this.fieldData = r);
                    var n = {
                        tag: "li",
                        attrs: { className: "stage-fields field-type-" + r.meta.id },
                        id: o.fieldID,
                        content: [h.default.actionButtons(o.fieldID, "field"), o.fieldEdit()],
                        panelNav: o.panelNav,
                        dataset: { hoverTag: l.default.get("field") },
                        fType: "fields",
                        action: {
                            mouseenter: function () {
                                document.getElementById(o.fieldID).classList.add("hovering-field");
                            },
                            mouseleave: function () {
                                document.getElementById(o.fieldID).classList.remove("hovering-field");
                            },
                        },
                    };
                    return (n = h.default.create(n)), h.default.fields.set(o.fieldID, { field: n, instance: o }), (o.preview = h.default.create(o.fieldPreview())), n.appendChild(o.preview), n;
                }
                return (
                    (e.prototype.updatePreview = function () {
                        var e = this,
                            t = u.default.copyObj(s.formData.fields.get(e.fieldID)),
                            o = h.default.create(t, !0);
                        return h.default.empty(e.preview), e.preview.appendChild(o), o;
                    }),
                    (e.prototype.editPanel = function (e) {
                        var t,
                            o,
                            r = this,
                            n = s.formData.fields.get(r.fieldID),
                            i = { tag: "div", className: "f-panel-wrap", content: [] };
                        if (n[e]) {
                            (o = { tag: "ul", attrs: { className: ["field-edit-group", "field-edit-" + e] }, editGroup: e, isSortable: "options" === e, content: [] }), (t = h.default.contentType(n[e])), i.content.push(o);
                            var a;
                            (a = "array" === t ? n[e] : Object.keys(n[e])),
                                u.default.forEach(a, function (i, a) {
                                    var l = { i: a, dataProp: i, fieldData: n, panelType: e, propType: t };
                                    o.content.push(r.panelContent(l));
                                });
                        }
                        return i;
                    }),
                    (e.prototype.panelContent = function (e) {
                        var t = this,
                            o = e.panelType,
                            r = e.dataProp,
                            n = s.formData.fields.get(t.fieldID);
                        r = "string" == typeof r ? r : e.i;
                        var i = (0, y.uuid)(),
                            a = n[o][r],
                            l = { tag: "div", className: ["prop-inputs"], content: t.editPanelInputs(r, a, o, i) },
                            d = { tag: "li", className: [o + "-" + r + "-wrap", "prop-wrap"], id: i, content: [] },
                            c = { tag: "button", attrs: { type: "button", className: "prop-order prop-control" }, content: h.default.icon("move-vertical") },
                            u = {
                                tag: "button",
                                attrs: { type: "button", className: "prop-remove prop-control" },
                                action: {
                                    click: function () {
                                        f.default.slideUp(document.getElementById(d.id), 250, function (e) {
                                            var n = e.parentElement,
                                                i = s.formData.fields.get(t.fieldID),
                                                a = i[o];
                                            h.default.remove(e), Array.isArray(a) ? a.splice(r, 1) : (a[r] = void 0), s.data.save(o, n), h.default.empty(t.preview);
                                            var l = h.default.create(i, !0);
                                            t.preview.appendChild(l), t.resizePanelWrap();
                                        });
                                    },
                                },
                                content: h.default.icon("remove"),
                            },
                            p = { tag: "div", className: "prop-controls", content: [u] };
                        return (
                            "array" === e.propType && (l.className.push("f-input-group"), p.content.unshift(c)), (d.propData = n[o][r]), this.isAllowedAttr(r) && d.content.push(p, l), d.className.push("control-count-" + p.content.length), d
                        );
                    }),
                    (e.prototype.editPanelInputs = function (e, t, o, r) {
                        var i = this,
                            a = [],
                            d = s.formData.fields.get(i.fieldID),
                            f = "options" === o;
                        return (
                            a.push(
                                (function t(a, c) {
                                    var p = h.default.contentType(c),
                                        m = "number" == typeof e,
                                        g = o + "." + a;
                                    m && (g = o + "[" + e + "]." + a);
                                    var b = function (e, t, o) {
                                            return {
                                                string: { type: "text", value: t, placeholder: l.default.get("placeholder." + e) || u.default.capitalize(e) },
                                                boolean: {
                                                    get type() {
                                                        var t = "checkbox";
                                                        return i.fieldData.attrs && "radio" === i.fieldData.attrs.type && "selected" === e && (t = "radio"), t;
                                                    },
                                                    value: t,
                                                },
                                                number: { type: "number", value: t },
                                                array: { className: "" },
                                            }[o];
                                        },
                                        v = function (e) {
                                            return l.default.get(o + "." + e) || u.default.capitalize(e);
                                        },
                                        y = {
                                            array: function (t, a) {
                                                return {
                                                    ...
                                                    id: e + "-" + r,
                                                    attrs: b(t, a, "array"),
                                                    config: { label: v(t), hideLabel: f },
                                                    content: a.map(function (e) {
                                                        return { tag: "option", attrs: { value: e.value, selected: e.selected }, content: e.label };
                                                    }),
                                                    action: {
                                                        change: function (r) {
                                                            var a = [],
                                                                ...
                                                                c = f ? l[t] : l,
                                                                p = c.map(function (e) {
                                                                    var t = (e.selected, n(e, ["selected"]));
                                                                    return a.push(t.value), t;
                                                                });
                                                            (p[a.indexOf(r.target.value)].selected = !0), u.default.set(d, g, p), s.data.save(), i.updatePreview();
                                                        },
                                                    },
                                                };
                                            },
                                            string: function (t, o) {
                                                var n = {
                                                    ...
                                                    action: {
                                                        change: function (e) {
                                                            u.default.set(d, g, e.target.value), i.updatePreview(), s.data.save();
                                                        },
                                                    },
                                                };
                                                return m || (n.config = { label: v(t) }), n;
                                            },
                                            boolean: function (t, o) {
                                                var n = {
                                                    tag: "input",
                                                    attrs: b(t, o, "boolean"),
                                                    fMap: g,
                                                    id: e + "-" + r,
                                                    name: i.fieldID + "-selected",
                                                    action: {
                                                        change: function (e) {
                                                            u.default.set(d, g, e.target.checked), i.updatePreview();
                                                        },
                                                    },
                                                };
                                                if ((o && (n.attrs.checked = o), m)) {
                                                    n = { tag: "span", className: "f-addon", content: h.default.checkbox(n) };
                                                } else n.config = { label: v(t) };
                                                return n;
                                            },
                                            object: function (e, o) {
                                                var r = [];
                                                for (var n in o) o.hasOwnProperty(n) && r.push(t(n, o[n]));
                                                return r;
                                            },
                                        };
                                    return (y.number = y.string), y[p](a, c);
                                })(e, t)
                            ),
                            a
                        );
                    }),
                    (e.prototype.isAllowedAttr = function () {
                        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "type",
                            t = this,
                            o = !0,
                            r = s.registeredFields[t.metaID].config.disabledAttrs;
                        return r && (o = !u.default.inArray(e, r)), o;
                    }),
                    (e.prototype.addAttribute = function (e, t) {
                        this.isAllowedAttr(e) || window.alert('Attribute "' + e + '": not permitted');
                        var o = this,
                            r = document.getElementById(o.fieldID),
                            n = r.querySelector(".field-edit-attrs"),
                            i = u.default.hyphenCase(e),
                            a = s.formData.fields.get(o.fieldID),
                            d = "attrs." + i;
                        l.default.current[d] || l.default.put(d, u.default.capitalize(e)), "string" == typeof t && u.default.inArray(t, ["true", "false"]) && (t = JSON.parse(t)), (a.attrs[i] = t);
                        var f = { dataObj: a, dataProp: i, i: Object.keys(a.attrs).length, panelType: "attrs" },
                            c = n.querySelector(".attrs-" + i + "-wrap"),
                            p = h.default.create(o.panelContent(f));
                        c ? n.replaceChild(p, c) : n.appendChild(p), s.data.save(f.panelType, n), o.updatePreview(), o.resizePanelWrap();
                    }),
                    (e.prototype.addOption = function () {
                        var e = this,
                            t = h.default.fields.get(e.fieldID).field,
                            o = s.formData.fields.get(e.fieldID),
                            r = o.options,
                            n = t.querySelector(".field-edit-options"),
                            i = (0, y.cleanObj)(r[r.length - 1]);
                        o.options.push(i);
                        var a = { i: n.childNodes.length, dataProp: i, dataObj: o, panelType: "options", propType: "array" };
                        n.appendChild(h.default.create(e.panelContent(a))), e.resizePanelWrap(), s.data.save(), h.default.empty(e.preview);
                        var l = h.default.create(s.formData.fields.get(e.fieldID), !0);
                        e.preview.appendChild(l);
                    }),
                    (e.prototype.panelEditButtons = function (e) {
                        var t = this;
                        return {
                            tag: "div",
                            attrs: { className: "panel-action-buttons" },
                            content: [
                                {
                                    tag: "button",
                                    attrs: { type: "button", className: "add-" + e },
                                    content: l.default.get("panelEditButtons." + e),
                                    action: {
                                        click: function (o) {
                                            var r = { btnCoords: h.default.coords(o.target) };
                                            "attrs" === e
                                                ? ((r.addAction = t.addAttribute.bind(t)), (r.message = { attr: l.default.get("action.add.attrs.attr"), value: l.default.get("action.add.attrs.value") }))
                                                : "options" === e && (r.addAction = t.addOption.bind(t));
                                            var n = u.default.capitalize(e),
                                                i = new CustomEvent("onAdd" + n, { detail: r });
                                            m.default.add[e](r), document.dispatchEvent(i);
                                        },
                                    },
                                },
                            ],
                    ...
                    (e.prototype.fieldEdit = function () {
                        var e = this,
                            t = [],
                            o = ["object", "array"],
                            r = ["config", "meta", "action"],
                            n = s.formData.fields.get(e.fieldID),
                            i = Object.keys(n).filter(function (e) {
                                return !u.default.inArray(e, r);
                            }),
                            a = { tag: "div", className: ["field-edit", "slide-toggle", "panels-wrap"] };
                        u.default.forEach(i, function (r) {
                            var i = h.default.contentType(n[r]);
                            if (u.default.inArray(i, o)) {
                                var a = { tag: "div", attrs: { className: "f-panel " + r + "-panel" }, config: { label: l.default.get("panelLabels." + r) || "" }, content: [e.editPanel(r), e.panelEditButtons(r)], action: {} };
                                t.push(a);
                            }
                        });
                        var d = { panels: t, id: e.fieldID };
                        if (t.length) {
                            var f = (e.panels = new v.default(d));
                            a.className.push("panel-count-" + t.length), (a.content = f.content), (e.panelNav = f.nav), (e.resizePanelWrap = f.actions.resize);
                        } else
                            setTimeout(function () {
                                var t = h.default.fields.get(e.fieldID).field,
                                    o = t.querySelector(".item-edit-toggle"),
                                    r = t.querySelector(".field-actions"),
                                    n = r.getElementsByTagName("button");
                                (r.style.maxWidth = 24 * n.length + "px"), h.default.remove(o);
                            }, 0);
                        return a;
                    }),
                    (e.prototype.fieldPreview = function () {
                        var e = this,
                            t = (0, y.clone)(s.formData.fields.get(e.fieldID)),
                            o = h.default.fields.get(e.fieldID).field,
                            r = function (e) {
                                var t = o.parentElement;
                                if ("true" === e.target.contentEditable)
                                    if (u.default.inArray(e.type, ["focus", "blur"])) {
                                        var r = document.activeElement === e.target;
                                        t.classList.toggle("editing-field-preview", r), h.default.toggleSortable(o.parentElement, "focus" === e.type);
                                    } else u.default.inArray(e.type, ["mousedown", "mouseup"]) && h.default.toggleSortable(o.parentElement, "mousedown" === e.type);
                            };
                        return (
                            (t.id = "prev-" + e.fieldID),
                            {
                                tag: "div",
                                attrs: { className: "field-preview" },
                                content: h.default.create(t, !0),
                                action: {
                                    focus: r,
                                    blur: r,
                                    mousedown: r,
                                    ...
                                    change: function (t) {
                                        var o = t.target;
                                        if (o.fMap) {
                                            var r = s.formData.fields.get(e.fieldID),
                                                n = o.checked,
                                                i = o.type,
                                                a = o.fMap;
                                            if (u.default.inArray(i, ["checkbox", "radio"])) {
                                                var l = r.options;
                                                "radio" === i &&
                                    ...
                                    click: function (e) {
                                        "true" === e.target.contentEditable && e.preventDefault();
                                    },
                                    input: function (t) {
                                        var o = s.formData.fields.get(e.fieldID),
                                            r = "content";
                                        t.target.fMap && (r = t.target.fMap), "true" === t.target.contentEditable ? u.default.set(o, r, t.target.innerHTML) : u.default.set(o, r, t.target.value), s.data.save("field", e.fieldID);
                                    },
                                },
                            }
                        );
            ...
            h = (function () {
                function e(t) {
                    ...
                    var o,
                        r,
                        i = this,
                        a = (i.rowID = t || (0, g.uuid)());
                    o = { columns: [], id: i.rowID, config: { fieldset: !1, legend: "", inputGroup: !1 }, attrs: { className: "f-row" } };
                    var s = m.formData.rows.get(a);
                    m.formData.rows.set(a, p.default.merge(o, s)),
                        (r = {
                            tag: "li",
                            className: "stage-rows empty-rows",
                            dataset: { hoverTag: l.default.get("row"), editingHoverTag: l.default.get("editing.row") },
                            id: a,
                            content: [c.default.actionButtons(a, "row"), i.editWindow],
                            fType: "rows",
                        }),
                        (r = c.default.create(r));
                    var f = d.default.create(r, {
                        animation: 150,
                        fallbackClass: "column-moving",
                        forceFallback: !0,
                        group: { name: "rows", pull: !0, put: ["rows", "controls", "columns"] },
                        sort: !0,
                        onRemove: i.onRemove,
                        onEnd: i.onEnd,
                        onAdd: i.onAdd,
                    ...
                    return c.default.rows.set(a, { row: r, sortable: f }), r;
                }
                return (
                    (e.prototype.onSort = function (e) {
                        m.data.saveColumnOrder(e.target), m.data.save();
                    }),
                    (e.prototype.onRemove = function (e) {
                        c.default.columnWidths(e.from), m.data.saveColumnOrder(e.target), c.default.emptyClass(e.from);
                    }),
                    (e.prototype.onEnd = function (e) {
                        e.from.classList.contains("empty-rows") && c.default.removeEmpty(e.from), m.data.save();
                    }),
                    (e.prototype.onAdd = function (e) {
                        var t,
                            o = e.from,
                        ...
                        if (i) t = r;
                            ...
                            var s = p.default.get(m.registeredFields[r.id], "meta");
                            "layout" === s.group ? "layout-column" === s.id && c.default.addColumn(n.id) : ((t = c.default.addColumn(n.id)), c.default.addField(t.id, r.id));
                        }
                        (a || l) && c.default.remove(r), m.data.saveColumnOrder(n), c.default.columnWidths(n), c.default.emptyClass(n), m.data.save();
                    }),
                    i(e, [
                        {
                            key: "editWindow",
                            get: function () {
                                var e = this,
                                    t = m.formData.rows.get(e.rowID),
                                    o = { tag: "div", className: "row-edit group-config" },
                                    r = { tag: "label", content: l.default.get("row.settings.fieldsetWrap") },
                                    n = {
                                        tag: "input",
                                        id: e.rowID + "-fieldset",
                                        attrs: { type: "checkbox", checked: t.config.fieldset, ariaLabel: l.default.get("row.settings.fieldsetWrap.aria") },
                                        action: {
                                            click: function (e) {
                                                (t.config.fieldset = e.target.checked), m.data.save();
                                            },
                                        },
                                    },
                                    i = {
                                        tag: "input",
                                        id: e.rowID + "-inputGroup",
                                        attrs: { type: "checkbox", checked: t.config.inputGroup, ariaLabel: l.default.get("row.settings.inputGroup.aria") },
                                        action: {
                                            click: function (e) {
                                                (t.config.inputGroup = e.target.checked), m.data.save();
                                            },
                                        },
                                        config: { label: l.default.get("row.makeInputGroup"), description: l.default.get("row.makeInputGroupDesc") },
                                    },
                                    a = {
                                        tag: "input",
                                        attrs: { type: "text", ariaLabel: "Legend for fieldset", value: t.config.legend, placeholder: "Legend" },
                                        action: {
                                            input: function (e) {
                                                (t.config.legend = e.target.value), m.data.save();
                                            },
                                        },
                                        className: "",
                                    },
                                    s = [r, { tag: "div", className: "input-group", content: [{ tag: "span", className: "input-group-addon", content: n }, a] }];
                                s = c.default.formGroup(s);
                                var d = Object.assign({}, r, { content: "Define column widths" }),
                                    f = Object.assign({}, r, { content: "Layout Preset", className: "col-sm-4 form-control-label" }),
                                    u = { tag: "div", className: "col-sm-8", content: c.default.columnPresetControl(e.rowID) },
                                    p = c.default.formGroup([f, u], "row");
                                return (o.content = [i, c.default.create("hr"), s, c.default.create("hr"), d, p]), o;
                            },
                        },
                    ]),
                    e
    ...
    function (e, t, o) {
        ...
        var i = (function () {
            ...
            b = (function () {
                function e(t, o) {
                    n(this, e), (this.stageID = o || (0, g.uuid)());
                    var r = {
                        formSettings: [
                            {
                                tag: "input",
                                id: "form-title",
                                attrs: { className: "form-title", placeholder: d.default.get("Untitled Form"), value: d.default.get("Untitled Form"), type: "text" },
                                config: { label: d.default.get("Form Title") },
                            },
                            { tag: "input", id: "form-novalidate", attrs: { className: "form-novalidate", value: !1, type: "checkbox" }, config: { label: d.default.get("Form novalidate") } },
                            { tag: "input", id: "form-tags", attrs: { className: "form-tags", type: "text" }, config: { label: d.default.get("Tags") } },
                        ],
                    };
                    if (((h = Object.assign(h, r, t)), !f.formData.stages.get(this.stageID))) {
                        var i = { id: this.stageID, settings: {}, rows: [] };
                        f.formData.stages.set(this.stageID, i);
                    }
                    return this.loadStage();
                }
                return (
                    (e.prototype.loadStage = function () {
                        var e = this,
                            t = this.dom,
                            o = l.default.create(t.firstChild, {
                                animation: 150,
                                fallbackClass: "row-moving",
                                forceFallback: !0,
                                fallbackTolerance: 0,
                                group: { name: "stages", pull: !0, put: ["controls", "rows", "columns"] },
                                onAdd: e.onAdd.bind(e),
                                onRemove: e.onRemove.bind(e),
                                sort: !0,
                                onStart: function () {
                                    m.default.activeStage = e.stage;
                                },
                                onUpdate: function () {
                                    f.data.saveRowOrder(), f.data.save();
                                },
                                onSort: e.onSort,
                                draggable: ".stage-rows",
                                handle: ".item-handle",
                            });
                        return m.default.stages.set(this.stageID, { stage: this.stage, sortable: o }), (m.default.activeStage = this.stage), f.formData.stages.get(this.stageID).rows.length && m.default.loadRows(this.stage), t;
                    }),
                    (e.prototype.elementConfigs = function () {
                        var e = this,
                            t = {
                                stage: { tag: "ul", attrs: { className: ["stage", "empty-stages"], id: e.stageID }, fType: "stages" },
                                settings: { tag: "div", attrs: { className: "formeo-settings", id: e.stageID + "-settings" }, fType: "settings" },
                            };
                        return (t.settings.content = h.formSettings.slice()), t;
                    }),
                    ...
                    (e.prototype.onAdd = function (e) {
                        var t = this;
                        m.default.activeStage = t.stage;
                        var o,
                            r = e.from,
                            n = e.item,
                            i = e.to,
                            a = u.default.indexOfNode(n, i),
                            l = "stages" === r.fType ? n : m.default.addRow(),
                            s = "columns" === r.fType,
                            d = "rows" === r.fType;
                        if ("controlGroup" === r.fType) {
                            var c = f.registeredFields[n.id].meta;
                            "layout" === c.group ? "layout-column" === c.id && m.default.addColumn(l.id) : ((o = m.default.addColumn(l.id)), m.default.addField(o.id, n.id)), m.default.remove(n);
                        } else if (s) {
                            var p = m.default.addColumn(l.id);
                            p.appendChild(n), f.data.saveFieldOrder(p), m.default.emptyClass(p);
                        } else d && (l.appendChild(n), f.data.saveColumnOrder(l), m.default.emptyClass(l));
                        return i.insertBefore(l, i.children[a]), m.default.columnWidths(l), f.data.saveRowOrder(i), f.data.save();
                    }),
                    ...
                    i(e, [
                        {
                            ...
                            get: function () {
                                ...
                                var e = this.elementConfigs(),
                                    t = m.default.create({ tag: "div", attrs: { className: "stage-wrap" }, content: [e.stage, e.settings] });
                                return (this.stage = t.firstChild), t;
                            },
                        },
                    ]),
                    e
    ...
    function (e) {
        e.exports = function () {
            ...
            return (
                (e.toString = function () {
                    for (var e, t = [], o = 0; o < this.length; o++) (e = this[o]), e[2] ? t.push("@media " + e[2] + "{" + e[1] + "}") : t.push(e[1]);
                    return t.join("");
                }),
                (e.i = function (t, o) {
                    "string" == typeof t && (t = [[null, t, ""]]);
                    for (var r, n = {}, i = 0; i < this.length; i++) "number" == typeof (r = this[i][0]) && (n[r] = !0);
    ...
    function (e, t, o) {
        var r = o(17);
        "string" == typeof r && (r = [[e.i, r, ""]]), o(21)(r, {}), r.locals && (e.exports = r.locals);
    },
    function (e) {
        function t() {
        ...
        function i() {
            m && u && ((m = !1), u.length ? (p = u.concat(p)) : (g = -1), p.length && a());
        }
        function a() {
            if (!m) {
                var e = r(i);
        ...
        (c.nextTick = function (e) {
            ...
            if (1 < arguments.length) for (var o = 1; o < arguments.length; o++) t[o - 1] = arguments[o];
    ...
    function (e) {
        function t(e, t) {
            for (var o = 0; o < e.length; o++) {
                ...
                if (n) {
                    ...
                    for (; i < r.parts.length; i++) n.parts.push(l(r.parts[i], t));
                } else {
        ...
        function o(e) {
            for (var t = [], o = {}, r = 0; r < e.length; r++) {
                var n = e[r],
                    ...
                    l = n[2],
                    s = n[3],
                    d = { css: a, media: l, sourceMap: s };
                o[i] ? o[i].parts.push(d) : t.push((o[i] = { id: i, parts: [d] }));
            }
            return t;
        }
        function r(e, t) {
            var o = m(),
                r = b[b.length - 1];
            if ("top" === e.insertAt) r ? (r.nextSibling ? o.insertBefore(t, r.nextSibling) : o.appendChild(t)) : o.insertBefore(t, o.firstChild), b.push(t);
            else {
        ...
        function l(e, t) {
            ...
            if (t.singleton) {
                var c = h++;
                (o = g || (g = i(t))), (r = s.bind(null, o, c, !1)), (l = s.bind(null, o, c, !0));
            } else
        ...
        e.exports = function (e, r) {
            ...
            (r = r || {}), void 0 === r.singleton && (r.singleton = p()), void 0 === r.insertAt && (r.insertAt = "bottom");
            var n = o(e);
            return (
                t(n, r),
                function (e) {
    ...
    function (e, t) {
        t = e.exports = function () {
            for (var e, o = "", r = 0; 32 > r; r++) (e = 0 | (16 * t.random())), 4 < r && 21 > r && !(r % 4) && (o += "-"), (o += (12 === r ? 4 : 16 === r ? 8 | (3 & e) : e).toString(16));
            return o;
        };
